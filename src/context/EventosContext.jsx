...
export const METAS_PROGRESSO = [
  ...
  { id: 'jogo_arena',     label: 'Jogou LDI Gangues',                 tipo: 'jogo_jogado',        descricao_contains: 'Gangues' },
  { id: 'arena_vitoria',  label: 'Venceu uma batalha de gangue',      tipo: 'arena_vitoria',      valor_min: 1 },
  { id: 'arena_level5',   label: 'Chegou ao nível 5 no Gangues',      tipo: 'arena_levelup',      valor_min: 5 },
