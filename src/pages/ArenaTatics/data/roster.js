...
export const ROSTER = [
  { id: 1, nome: 'Ferro Velho', classe: 'karuak', elemental: 'terra',
    caminhoEvolutivo: { nivel40: 'muralha', nivel70: 'bastiao' },
    papel: 'tanque', noPool: true,
  ...
  { id: 2, nome: 'Relâmpago Branco', classe: 'moraki', elemental: 'relampago',
    caminhoEvolutivo: { nivel40: 'fantasma', nivel70: 'espectro' },
    papel: 'dps', noPool: true,
  ...
  { id: 3, nome: 'Espiral', classe: 'tivara', elemental: 'luz',
    caminhoEvolutivo: { nivel40: 'precisao', nivel70: 'perfuracao' },
    papel: 'dps', noPool: true,
  ...
  { id: 4, nome: 'Dente de Sabre', classe: 'karuak', elemental: 'vento',
    caminhoEvolutivo: { nivel40: 'avalanche', nivel70: 'cataclisma' },
    papel: 'tanque', noPool: true,
  ...
  { id: 5, nome: 'Sombra de Gelo', classe: 'tivara', elemental: 'gelo',
    caminhoEvolutivo: { nivel40: 'precisao', nivel70: 'miragem' },
    papel: 'dps', noPool: true,
  ...
  { id: 6, nome: 'Montanha Viva', classe: 'karuak', elemental: 'terra',
    caminhoEvolutivo: { nivel40: 'avalanche', nivel70: 'colosso' },
    papel: 'tanque', noPool: true,
  ...
  { id: 7, nome: 'Tocha Sagrada', classe: 'tivara', elemental: 'fogo',
    caminhoEvolutivo: { nivel40: 'arco_ancestral', nivel70: 'arco_negro' },
    papel: 'suporte', noPool: true,
  ...
  { id: 8, nome: 'Lobo de Wendor', classe: 'tivara', elemental: 'metal',
    caminhoEvolutivo: { nivel40: 'arco_ancestral', nivel70: 'arco_sagrado' },
    papel: 'dps', noPool: true,
  ...
  { id: 9, nome: 'Sete Cicatrizes', classe: 'moraki', elemental: 'vento',
    caminhoEvolutivo: { nivel40: 'tufao', nivel70: 'ciclone' },
    papel: 'dps', noPool: true,
  ...
  { id: 10, nome: 'Língua de Cobra', classe: 'moraki', elemental: 'natureza',
    caminhoEvolutivo: { nivel40: 'fantasma', nivel70: 'sombra' },
    papel: 'disruptor', noPool: true,
  ...
  { id: 12, nome: 'Névoa da Manhã', classe: 'moraki', elemental: 'agua',
    caminhoEvolutivo: { nivel40: 'tufao', nivel70: 'vortice' },
    papel: 'disruptor', noPool: true,
  ...
  { id: 14, nome: 'Cinza', classe: 'karuak', elemental: 'trevas',
    caminhoEvolutivo: { nivel40: 'muralha', nivel70: 'fortaleza' },
    papel: 'suporte', noPool: true,
  ...
  { id: 19, nome: 'Rugido', classe: 'tivara', elemental: 'relampago',
    caminhoEvolutivo: { nivel40: 'arco_ancestral', nivel70: 'perfuracao' },
    papel: 'suporte', noPool: true,
