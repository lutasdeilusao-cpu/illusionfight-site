...
export const CASOS = {
  caso1: {
    ...
    dialogoAbertura: [
      { personagem: 'narração', texto: 'ela apareceu no boteco às duas da manhã. cabelo rosa. cara de quem não pede favor.' },
      { personagem: 'nina', texto: '"osvaldo sumiu. três dias. a oficina tá fechada."' },
      { personagem: 'jack', texto: 'eu olhei pra minha cerveja. depois pra ela. depois pra cerveja de novo.' },
      { personagem: 'nina', texto: '"quanto você cobra?"' },
      { personagem: 'jack', texto: '"nada."' },
      { personagem: 'nina', texto: '"então para que você serve?"' },
      { personagem: 'jack', texto: '"tô dentro."' },
      { personagem: 'nina', texto: '"não sorria."' },
      { personagem: 'jack', texto: 'eu não estava sorrindo. tecnicamente.' },
    ],
    dialogoResolucao: [
      { personagem: 'jack', texto: 'encontrei o cobrador fantasma. osvaldo voltou. caso encerrado.' },
      { personagem: 'nina', texto: '"demorou."' },
      { personagem: 'jack', texto: '"três dias é rápido."' },
      { personagem: 'nina', texto: '"eu teria feito em dois."' },
      { personagem: 'jack', texto: 'provavelmente verdade. eu não disse isso.' },
      { personagem: 'nina', texto: '"obrigada." ela disse sem olhar.' },
      { personagem: 'jack', texto: 'no sonho isso conta como elogio.' },
    ],
    abertura: [
