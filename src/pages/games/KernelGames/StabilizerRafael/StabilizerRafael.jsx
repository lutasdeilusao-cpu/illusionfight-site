...
function PuzzleStabilizerRafael({ onSolve, onFail, onBack, initialDiff }) {
...
export default function StabilizerRafael() {
    ...
    return (
      <div className="kg-page">
        ...
        <div className="kg-result">
          ...
          <p className="kg-result-sub">{t('site.games.nomes.stabilizer_rafael')}</p>
  ...
  return (
    <div className="kg-page">
      <div className="kg-scanlines" />
      <PuzzleStabilizerRafael key={plays} onSolve={handleSolve} onFail={handleFail} onBack={() => navigate('/games')} />
    </div>
  )
}
