...
function PuzzleMazeRafael({ onSolve, onFail, onBack, initialDiff }) {
...
export default function MazeRafael() {
    ...
    return (
      <div className="kg-page">
        ...
        <div className="kg-result">
          ...
          <p className="kg-result-sub">{t('site.games.nomes.maze_rafael')}</p>
  ...
  return (
    <div className="kg-page">
      <div className="kg-scanlines" />
      <PuzzleMazeRafael key={plays} onSolve={handleSolve} onFail={handleFail} onBack={() => navigate('/games')} />
    </div>
  )
}
