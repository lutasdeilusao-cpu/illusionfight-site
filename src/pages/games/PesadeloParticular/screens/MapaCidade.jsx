  ...
  return (
    <div className="pp-container pp-mapa-padding-top">
      <div className="pp-mapa-title-wrap">
        ...
        <p className="pp-subtitle"><span className="pp-cursor">â–ˆ</span> {t('pp.mapa.subtitulo')}</p>
      </div>
        ...
        {tooltip && (
          <div className="pp-mapa-tooltip" style={{ left: tooltip.x, top: tooltip.y }}>
            ...
            <div className="pp-mapa-tooltip-diff">
              {'â—†'.repeat(tooltip.dificuldade)} Â· {tooltip.reputacao_minima > 0 ? `${tooltip.reputacao_minima} rep` : t('pp.mapa.sem_requisito')}
            </div>
          </div>
        )}
      </div>
