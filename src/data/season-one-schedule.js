...
export const SEASON_ONE_DROPS = [
  ...
  { date: '2026-12-15', subscriber: 'LDI Cap. 2', account: '—', public: 'LDI Cap. 1 (WEB SHARD)', outras: 'Parte 1 (Cap.1/2)' },
  { date: '2026-12-30', subscriber: '—', account: 'LDI Cap. 2', public: '—', outras: 'Parte 2 (Cap.1/2) — fecha Cap.1' },
  { date: '2027-01-14', subscriber: '—', account: '—', public: 'LDI Cap. 2', outras: 'Parte 3 (Cap.2/2)' },
  { date: '2027-01-15', subscriber: 'LDI Cap. 3', account: '—', public: '—', outras: '—' },
  { date: '2027-01-29', subscriber: '—', account: '—', public: '—', outras: 'Parte 4 (Cap.2/2) — fecha Cap.2' },
  { date: '2027-01-30', subscriber: '—', account: 'LDI Cap. 3', public: '—', outras: '—' },
  ...
  { date: '2027-02-14', subscriber: '—', account: '—', public: 'LDI Cap. 3', outras: '—' },
  ...
  { date: '2027-03-15', subscriber: 'LDI Cap. 4', account: '—', public: '—', outras: '—' },
  { date: '2027-03-30', subscriber: '—', account: 'LDI Cap. 4', public: '—', outras: 'Parte 7 (Cap.4/2) — fecha junto com o lançamento do portal' },
  { date: '2027-04-14', subscriber: '—', account: '—', public: 'LDI Cap. 4', outras: 'Parte 8 (Cap.4/2) — fecha Cap.4' },
  { date: '2027-04-15', subscriber: 'LDI Cap. 5', account: '—', public: '—', outras: '—' },
  { date: '2027-04-30', subscriber: '—', account: 'LDI Cap. 5', public: '—', outras: 'Parte 9 (Cap.5/2)' },
  { date: '2027-05-15', subscriber: 'LDI Cap. 6', account: '—', public: 'LDI Cap. 5', outras: 'Parte 10 (Cap.5/2) — fecha Cap.5' },
  { date: '2027-05-30', subscriber: '—', account: 'LDI Cap. 6', public: '—', outras: 'Parte 11 (Cap.6/2)' },
  ...
  { date: '2027-06-14', subscriber: '—', account: '—', public: 'LDI Cap. 6', outras: 'Parte 12 (Cap.6/2) — fecha Cap.6' },
  ...
  { date: '2027-07-15', subscriber: 'LDI Cap. 7', account: '—', public: '—', outras: '—' },
  { date: '2027-07-30', subscriber: '—', account: 'LDI Cap. 7', public: '—', outras: 'Parte 13 (Cap.7/2) — fecha junto com o portal' },
  { date: '2027-08-14', subscriber: '—', account: '—', public: 'LDI Cap. 7', outras: 'Parte 14 (Cap.7/2) — fecha Cap.7' },
  { date: '2027-08-15', subscriber: 'LDI Cap. 8', account: '—', public: '—', outras: '—' },
  { date: '2027-08-30', subscriber: '—', account: 'LDI Cap. 8', public: '—', outras: 'Parte 15 (Cap.8/2) — fecha junto com o portal' },
  { date: '2027-09-14', subscriber: '—', account: '—', public: 'LDI Cap. 8', outras: 'Parte 16 (Cap.8/2) — fecha Cap.8' },
  { date: '2027-09-15', subscriber: 'LDI Cap. 9', account: '—', public: '—', outras: '—' },
  { date: '2027-09-30', subscriber: '—', account: 'LDI Cap. 9', public: '—', outras: 'Parte 17 (Cap.9/2) — fecha junto com o portal' },
  ...
  { date: '2027-10-15', subscriber: '—', account: '—', public: 'LDI Cap. 9', outras: 'Parte 18 (Cap.9/2) — fecha Cap.9' },
  ...
  { date: '2027-12-15', subscriber: 'Temporada 2, Cap. 1', account: '—', public: '—', outras: '—' },
  { date: '2027-12-30', subscriber: '—', account: 'Temporada 2, Cap. 1', public: '—', outras: 'Parte 19 (Cap.10/2) — retoma junto com o portal' },
  { date: '2028-01-14', subscriber: '—', account: '—', public: 'Temporada 2, Cap. 1', outras: 'Parte 20 (Cap.10/2) — fecha Cap.10' },
