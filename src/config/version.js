...
// ── Site ──────────────────────────────────────────
export const SITE_VERSION = '10.46.3'
...
export const TS_VERSION        = '5.14.1'  // Top Trumps Single Player: fix — tentativas diárias: await consumirTentativa, usa deckUsuario (não localStorage), server-side validation em escolherRecompensa
