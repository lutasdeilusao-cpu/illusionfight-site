...
// ── Site ──────────────────────────────────────────
export const SITE_VERSION = '10.121.0'
...
export const PROTOTYPE_VERSION = '6.2.0' // Protótipo — Arena Testbed: correções — radial menu fixed, centralização canvas, top bar contextual, limpeza de estado finalizarTurno, clamp radial
