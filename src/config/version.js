...
// ── Site ──────────────────────────────────────────
export const SITE_VERSION = '10.157.12'
...
export const ARENATESTBED_VERSION = '5.9.3' // Fix ficha duplicava no localStorage + track fichaId para upsert + modal confirmação exclusão
