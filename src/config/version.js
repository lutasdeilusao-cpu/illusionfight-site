...
// ── Site ──────────────────────────────────────────
export const SITE_VERSION = '10.96.0'
...
export const ARENA_VERSION     = '1.30.0'  // LDI Arena Testbed: fixes regras (gastar pontos, PDF range, obstáculos) + animações de combate
...
export const PROTOTYPE_VERSION = '2.2.1' // Protótipo — Arena Testbed: fix startPlayerTurn is not defined (função faltando)
