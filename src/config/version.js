 ...
 */
 ...
 // ── Site ──────────────────────────────────────────
export const SITE_VERSION = '10.241.0'

// ── Games ─────────────────────────────────────────
export const PP_VERSION        = '2.3.1'  // Pesadelo Particular — fix: guest i18n keys movidas para o namespace pp em pt/en/es.json
export const LDI_VERSION       = '2.0.1'  // Lendas do LDI — guest aviso melhorado no lobby (título, texto explicativo, link cadastro)
export const JACK_VERSION      = '5.3.2'  // Jack Dream Beer — correção de encoding em comentário
export const GANGUES_VERSION   = '2.17.0' // fix: cor padrao dos pinos da cena (GanguesCena.css) era um teal fixo (#0f5e65) quase identico ao azul dos nodes de farm repetiveis (#0b3a66) - sem contraste real, dava pra jurar que "nao ficou azul" mesmo quando ficou. Pino padrao agora usa var(--terr-cor) do territorio (verde #3ddc97 na Pista), farm continua azul distinto - agora da pra notar a diferenca de verdade
