...
// ── Site ──────────────────────────────────────────
export const SITE_VERSION = '10.34.0'
...
export const TAMA_VERSION      = '1.38.1' // Tamagoshi LDI — fix: pet persistence (termo não reaparece + dados não são deletados no load)
