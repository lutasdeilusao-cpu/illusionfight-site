...
// ── Site ──────────────────────────────────────────
export const SITE_VERSION = '10.156.44'
...
export const TAMA_VERSION      = '3.0.3' // Tamagoshi LDI — fix: BOM + double-encoding + add ID 2(Ninka) 3(Kroum) + reorder IDs 1-32 + fix build
