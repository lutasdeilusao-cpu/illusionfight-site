...
// ── Site ──────────────────────────────────────────
export const SITE_VERSION = '10.45.0'
...
export const TS_VERSION        = '5.13.0'  // Top Trumps Single Player: fix repetição de cartas na partida (deck dividido sem repetir, proximaRodada sem módulo)
export const TM_VERSION        = '5.8.0'  // Top Trumps Multiplayer: fix repetição de cartas (dedup no carregamento do deck, embaralhamento)
