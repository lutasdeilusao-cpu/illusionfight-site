 ...
 */
 ...
 // ── Site ──────────────────────────────────────────
export const SITE_VERSION = '10.280.113' // fix: pagina privada /preview-privado/webtoon-00-comparar - Isaias pediu pra recortar as 2 imagens unificadas (scroll gigante de todas as paginas coladas numa so) em paginas individuais, pra comparar pagina a pagina com o socio. Recortadas por altura igual (32 paginas no remake, 37 na versao antiga - a versao antiga bateu EXATO: 47360px/37=1280px por pagina, confirmando que essa era a altura real de cada pagina original) via script Python local, verificado visualmente que nenhum corte cai no meio de um painel. WebtoonCompare.jsx agora lista cada pagina com rotulo "pag. N" em vez do scroll unico. scripts/restaurar-preview-privado.cjs reescrito pra restaurar as 69 paginas individuais (era so 2 arquivos unificados antes) de um novo commit fixo do gh-pages.
