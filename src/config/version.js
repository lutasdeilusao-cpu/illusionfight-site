 ...
 */
 ...
 // ── Site ──────────────────────────────────────────
export const SITE_VERSION = '10.287.1' // fix(webshard): miniatura do capítulo virou a capa INTEIRA em retrato (proporção da página, 240×409) em vez de recorte quadrado 320×320 — lista de capítulos e card "Continuar lendo".
