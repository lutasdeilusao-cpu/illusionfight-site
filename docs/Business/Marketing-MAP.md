...
4. BANCO DE VÍDEOS — 12/12 PRONTOS ✅
...
Status: máquina ligada. Publicação pode começar.

5. METODOLOGIA DE PRODUÇÃO DE VÍDEO (aprovada 10/06/2026)

Construir storyboard frame por frame no Nano Banana
Aprovar cada frame antes de avançar
Só quando todos os frames aprovados, entregar ao Seedance/Kling
Instrução: "só anima, exatamente nessa ordem"
Áudio: gravar no ElevenLabs Eleven v3 com Audio Tags
Editar com áudio + imagens no editor de vídeo
...
✅ 12 vídeos produzidos e em privado
...
✅ Banco de vídeos completo — 12/12
Fase 2 — Aquecimento (semanas 1–12) ← PRÓXIMA ETAPA
