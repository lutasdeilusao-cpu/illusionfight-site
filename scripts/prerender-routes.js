...
const ROUTES = [
  ...
  ['/mundo', 'Universos — Illusion Fight', 'Os três universos de Isaias Leal: Lutas de Ilusão, O Mundo das Sombras e Mar de Cinzas. Lore, raças, mapas e glossários.', 'Os universos de Illusion Fight', 'Explore o worldbuilding dos três universos do criador: Lutas de Ilusão, O Mundo das Sombras e Mar de Cinzas.', '0.8', 'monthly'],
  ['/mundo/lutas-de-ilusao', 'Mundo de Illusion Fight', 'Explore Bravara, a arena LDI, personagens, facções e a história do universo Illusion Fight.', 'O mundo de Illusion Fight', 'Descubra a lore, os lugares, as organizações e os acontecimentos do universo LDI.', '0.8', 'monthly'],
  ['/mundo/mundo-das-sombras', 'O Mundo das Sombras — universo | Illusion Fight', 'O worldbuilding de O Mundo das Sombras: as Sombras e os Iluminados, os Marcados, o Escudo, o glossário do Arco 1.', 'O universo de O Mundo das Sombras', 'As Sombras e os Iluminados, os Marcados, o Escudo — o que os personagens sabem até o fim do Arco 1.', '0.5', 'monthly'],
