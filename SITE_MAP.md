...
|---|---|---|
| `SITE_VERSION` | **10.160.27** | FEAT: 3 melee attack animations — StandardPlus + RageDash + EnergyPunch |
...
| `ARENATESTBED_VERSION` | **6.15.0** | FEAT: 3 melee attack animations — StandardPlus + RageDash + EnergyPunch |
