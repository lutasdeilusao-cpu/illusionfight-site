...
*Versão: 2.04*  |  `[SITE] versão carregada: 2.04`
...
| `/games/ldi-tatics` | ArenaTaticsRoute | `src/pages/ArenaTatics/ArenaTaticsRoute.jsx` | ✅ v2.5.0 | LDI TATICS — sistema de classes Ragnarok, grid 8×16, 3v3 tático por turnos, árvore de evolução — **1ª temporada** |
