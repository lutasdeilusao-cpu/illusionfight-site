...
|---|---|---|
| `SITE_VERSION` | **10.156.82** | Reverter Phase3Combat ao estado pré-refatoração + estudo |
...
| `ARENATESTBED_VERSION` | **2.0.3** | Reverter Phase3Combat ao último estado funcional pré-refatoração |
