...
|---|---|---|
| `SITE_VERSION` | **10.156.50** | Tamagoshi — force audit: remove identifiers nome→ID + i18n Kroniki→criatura |
...
| `TAMA_VERSION` | **3.3.1** | Tamagoshi LDI — force audit: remove identifiers nome→ID + i18n Kroniki→criatura |
