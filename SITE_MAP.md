...
|---|---|---|
| `SITE_VERSION` | **10.98.0** 🛠️ | Site — Arena Testbed: refatoração completa linha de visão (coordenadas cúbicas) + alcance de ataque |
...
| `PROTOTYPE_VERSION` | **2.3.0** | Protótipo — Arena Testbed: refatoração completa linha de visão (coordenadas cúbicas) + alcance de ataque |
