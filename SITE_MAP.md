...
*Versão: 8.4*  |  `[SITE] versão carregada: 8.4`  |  🌐 **`https://illusionfight.com/`** (domínio oficial)
*Versão: 8.4*  |  `[SITE] versão carregada: 8.4`  |  🌐 **`https://illusionfight.com/`** (domínio oficial)
*TATICS versão: 7.0.0* | `[TATICS] versão carregada: 7.0.0`
*MP versão: 4.0.4* | `[MP] versão carregada: 4.0.4`
...
| `/games/toptrumps` | TopTrumps | `src/pages/TopTrumps.jsx` | ✅ v4.0.4 | ✅ 1ª temp. | ✅ PT ✅ EN ✅ ES | Cartas colecionáveis, deck, recompensa diária |
