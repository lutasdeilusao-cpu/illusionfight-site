...
|---|---|---|
| `SITE_VERSION` | **10.182.1** | TopTrumps v2 — useGameEffects + componentes visuais (fase 2) |
...
| `TS_VERSION` | **5.41.1** | Top Trumps SP v2 — useGameEffects + componentes visuais (fase 2) |
