...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-30 — v10.192.51 (barreira de sincronização do Top Trumps MP)
...
|---|---|---|
| `SITE_VERSION` | **10.192.51** | Barreira de sincronização do Top Trumps MP |
...
| `TM_VERSION` | **5.12.7** | Top Trumps MP — barreira de sincronização antes de cada jogada |
