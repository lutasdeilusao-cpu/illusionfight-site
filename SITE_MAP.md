...
|---|---|---|
| `SITE_VERSION` | **10.160.15** | FIX: fill transparent no overlay projétil — preserva tile texture nas células do caminho |
...
| `ARENATESTBED_VERSION` | **6.9.12** | FIX: fill transparent no overlay projétil — preserva tile texture nas células do caminho |
