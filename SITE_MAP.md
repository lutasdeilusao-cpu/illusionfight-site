...
|---|---|---|
| `SITE_VERSION` | **10.157.37** | Task 3: callbacks visuais onDano/onBalao/onAnimarMelee/onAnimarProjetil |
...
| `ARENATESTBED_VERSION` | **5.15.3** | Task 3: callbacks visuais onDano/onBalao/onAnimarMelee/onAnimarProjetil, remove duplicatas do Phase6 |
