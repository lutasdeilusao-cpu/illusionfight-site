...
|---|---|---|
| `SITE_VERSION` | **10.156.93** | Arena: sequenciar anúncios de turno + lock global de input |
...
| `ARENATESTBED_VERSION` | **5.1.0** | Sequenciar anúncios de turno + lock global de input |
