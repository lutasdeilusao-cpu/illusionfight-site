...
|---|---|---|
| `SITE_VERSION` | **10.114.0** | Site — Protótipo: fix canvas Phase3 Pixi não renderizava (rAF race + hexSize 30 estático) |
...
| `PROTOTYPE_VERSION` | **4.4.0** | Protótipo — Arena Testbed: fix canvas Phase3 Pixi não renderizava (rAF race + hexSize 30 estático) |
