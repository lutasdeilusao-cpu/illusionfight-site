...
*Versão: 1.76*  |  `[SITE] versão carregada: 1.76`
...
| `/games/tamagoshi` | Tamagoshi | `src/pages/Tamagoshi/Tamagoshi.jsx` | ✅ v1.7.1 | Tamagoshi LDI — ciclo de vida completo, DIX economy, loja, 3 minigames, Hall da Fama |

**Versão atual:** `1.7.1` (console: `[TAMA] versão carregada: 1.7.1`)
