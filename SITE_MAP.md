...
|---|---|---|
| `SITE_VERSION` | **10.156.84** | Renomear Phase3Combat.css + inline styles removidos |
...
| `ARENATESTBED_VERSION` | **3.0.0** | Fase de seleção de poderes + poderes ativos ataque/defesa |
