...
| `/games/ldi-tatics` | ArenaTaticsRoute | `src/pages/ArenaTatics/ArenaTaticsRoute.jsx` | ✅ v5.3.4 | LDI TATICS — sistema tático por turnos, grid 8×16 isométrico, 20 personagens, 3v3, equipamentos, sistema de desbloqueio, juice visual, 16 IAs, simulação automática |
