...
|---|---|---|
| `SITE_VERSION` | **10.156.79** | Phase3Combat refatorado — 7 extrações de baixo risco |
...
| `ARENATESTBED_VERSION` | **2.0.0** | Phase3Combat refatorado: draw/turnOrder/modais/HUD extraídos |
