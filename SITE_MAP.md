...
|---|---|---|
| `SITE_VERSION` | **10.175.0** | Fix: layout fase jogando — mini card DOM height + VS heartbeat + player card flex |
...
| `TS_VERSION` | **5.33.0** | Top Trumps SP — fix layout jogando: mini card DOM height + VS heartbeat + player card flex |
