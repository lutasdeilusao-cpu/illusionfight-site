...
|---|---|---|
| `SITE_VERSION` | **10.156.24** | Site — fixes finais: morte contra-ataque, agi default 1, rows=4, limpeza |
...
| `ARENATESTBED_VERSION` | **1.10.25** | Arena Testbed — fixes finais: morte contra-ataque, agi default 1, rows=4, limpeza |
