...
|---|---|---|
| `SITE_VERSION` | **10.100.0** | Site — Arena Testbed: refactor fluxo combate jogador + fixes visuais crítico/projétil/morte |
...
| `PROTOTYPE_VERSION` | **2.5.0** | Protótipo — Arena Testbed: refactor fluxo combate jogador + fixes visuais crítico/projétil/morte |
