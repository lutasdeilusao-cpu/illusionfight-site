...
|---|---|---|
| `SITE_VERSION` | **10.156.33** | Tamagoshi LDI — i18n completo puzzle names (stealth, decoder, sliding, labirinto, anagrama, forca) |
...
| `TAMA_VERSION` | **2.6.0** | Tamagoshi LDI — i18n completo puzzle names (stealth, decoder, sliding, labirinto, anagrama, forca) |
