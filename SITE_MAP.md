...
|---|---|---|
| `SITE_VERSION` | **10.179.1** | Fix: tela resultado final centralizada + botão som não sobrepõe título |
...
| `TS_VERSION` | **5.37.1** | Top Trumps SP — tela resultado final centralizada + botão som não sobrepõe título |
