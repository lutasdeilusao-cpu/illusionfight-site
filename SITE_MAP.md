...
|---|---|---|
| `SITE_VERSION` | **10.156.97** | Arena: fix IA agindo 2x + ordem não persistindo — avanço por ID |
...
| `ARENATESTBED_VERSION` | **5.2.3** | Fix IA agindo 2x + ordem não persistindo — avanço por ID em vez de turnRef |
