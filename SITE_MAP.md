...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-29 — v10.192.42 (variantes visuais do Arena Report)
...
| `/games/toptrumps` | TopTrumpsSP | `src/pages/games/TopTrumps/TopTrumpsSP.jsx` | ✅ v5.44.19 | ✅ 1ª temp. ✅ Deck Build | ✅ PT ✅ EN ✅ ES | Versão oficial; Arena Report com variantes de vitória, derrota e empate |
| `/games/toptrumps/v2` | TopTrumpsSP | `src/pages/games/TopTrumps/TopTrumpsSP.jsx` | ✅ v5.44.19 | ✅ 1ª temp. ✅ Deck Build | ✅ PT ✅ EN ✅ ES | Alias para /games/toptrumps; CSS modular |
...
|---|---|---|
| `SITE_VERSION` | **10.192.42** | Variantes visuais do Arena Report |
...
| `TS_VERSION` | **5.44.19** | Top Trumps — variantes visuais do Arena Report |
