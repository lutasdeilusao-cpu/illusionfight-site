...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-31 — v10.192.72 (lobby compartilhado integrado à sala real do Top Trumps)
...
| `/games/multiplayer/lobby` | MultiplayerLobby | `src/pages/games/MultiplayerLobby/MultiplayerLobby.jsx` | ✅ v3 | ✅ 🔒 | ✅ PT ✅ EN ✅ ES | Fila canônica do banco; confirma dois usuários e abre a mesma sala real do Top Trumps |
...
| `/games/toptrumps/multiplayer` | TopTrumpsMP | `src/pages/games/TopTrumps/TopTrumpsMP.jsx` | ✅ v5.13.4 | ✅ 🔒 | ✅ PT ✅ EN ✅ ES | Multiplayer funcional; recebe a sala real confirmada pelo lobby compartilhado |
...
|---|---|---|
| `SITE_VERSION` | **10.192.72** | Lobby compartilhado integrado à fila canônica e à sala real do Top Trumps |
...
| `TM_VERSION` | **5.13.4** | Top Trumps MP — dois usuários conciliados pelo lobby abrem a mesma sala real |
