...
| `/games/minigames` | MiniGames | `src/pages/MiniGames/MiniGames.jsx` | ✅ **v3.0.3** | ✅ **100%** | ✅ PT ✅ EN ✅ ES | 8 puzzles arcade, todos os níveis free |
...
|---|---|---|
| `SITE_VERSION` | **10.156.57** | MiniGames Decoder: remover log flood + verde prematuro |
...
| `MINIGAMES_VERSION` | **3.0.3** | Decoder: remover log flood + verde prematuro |
