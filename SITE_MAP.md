...
|---|---|---|
| `SITE_VERSION` | **10.157.40** | Task 4: remove estados duplicados de turno/subPhase/vitória, iniciarPartida substitui useEffect |
...
| `ARENATESTBED_VERSION` | **5.16.1** | Task 4: remove estados duplicados de turno/subPhase/vitória, iniciarPartida substitui useEffect |
