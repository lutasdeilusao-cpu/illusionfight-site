...
|---|---|---|
| `SITE_VERSION` | **10.160.23** | FEAT: movement animation system — Standard + Teleport + Slingshot |
...
| `ARENATESTBED_VERSION` | **6.13.0** | FEAT: movement animation system — Standard + Teleport + Slingshot |
