...
|---|---|---|
| `SITE_VERSION` | **10.160.38** | FEAT: synthesized SFX system — AudioManager + effectsMap sounds + combat/UI triggers across all phases |
...
| `ARENATESTBED_VERSION` | **6.21.0** | FEAT: synthesized SFX system — AudioManager + effectsMap sounds + combat/UI triggers across all phases |
