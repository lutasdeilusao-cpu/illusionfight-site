...
|---|---|---|
| `SITE_VERSION` | **10.179.5** | Refactor: layout fase jogando — dvh + scales por breakpoint + heights 100% |
...
| `TS_VERSION` | **5.38.0** | Top Trumps SP — refactor layout: dvh + scales por breakpoint + heights 100% |
