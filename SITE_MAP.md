...
|---|---|---|
| `SITE_VERSION` | **10.157.39** | Refatoração: return do useCombatEngine agrupado por domínio |
...
| `ARENATESTBED_VERSION` | **5.16.0** | Refatoração: return do useCombatEngine agrupado por domínio (combat, ui, ordering, move, set, actions, utils) |
