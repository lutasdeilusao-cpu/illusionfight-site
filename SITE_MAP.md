...
|---|---|---|
| `SITE_VERSION` | **10.158.1** | Phase6CombatV2 — fase de combate limpa + botão Treino V2 |
...
| `ARENATESTBED_VERSION` | **6.1.0** | Phase6CombatV2 — fase de combate limpa, zero lógica, botão Treino V2 |
