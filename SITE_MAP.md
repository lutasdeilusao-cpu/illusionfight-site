...
*Versão: 1.75*  |  `[SITE] versão carregada: 1.75`
...
| `/games/tamagoshi` | Tamagoshi | `src/pages/Tamagoshi/Tamagoshi.jsx` | ✅ v1.7.0 | Tamagoshi LDI — ciclo de vida completo, DIX economy, loja, 3 minigames, Hall da Fama |

**Versão atual:** `1.7.0` (console: `[TAMA] versão carregada: 1.7.0`)
