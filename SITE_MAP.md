...
|---|---|---|
| `SITE_VERSION` | **10.156.34** | Tamagoshi LDI — i18n completo data/ (falas, erros store, notificações, gacha) + getFala i18n fallback |
...
| `MORTO_VERSION` | **2.0.0** | Morto Engine — 3v3 com aliados, magia em fila, área, efeitos, reviver |
