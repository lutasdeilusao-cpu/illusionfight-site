...
| `/games/tamagoshi` | Tamagoshi | `src/pages/Tamagoshi/Tamagoshi.jsx` | ✅ v2.7.0 | ✅ S1 sprite completo! | ✅ PT ✅ EN ✅ ES | 10/10 criaturas S1 com sprite próprio, i18n completo pt/en/es + data/ strings |
| `/games/morto` | Morto | `src/pages/Morto/Morto.jsx` | ✅ **v2.1.0** | ✅ Protótipo | ✅ PT ✅ EN ✅ ES | Morto Engine — sistema 3v3 com criação, combate, magias, efeitos e reviver |
...
|---|---|---|
| `SITE_VERSION` | **10.156.35** | Morto Engine — rota /games/morto standalone com iframe + i18n pt/en/es |
...
| `TAMA_VERSION` | **2.7.0** | Tamagoshi LDI — i18n completo data/ (falas, erros store, notificações, gacha) + getFala i18n fallback |
...
| `MORTO_VERSION` | **2.1.0** | Morto Engine — rota /games/morto standalone com iframe + i18n pt/en/es |
