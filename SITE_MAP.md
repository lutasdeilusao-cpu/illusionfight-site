...
|---|---|---|
| `SITE_VERSION` | **10.158.2** | Fix iaThinking preso em true + cleanup V2: remove addLog/addBalao/remainingMove/getPoderesPorId |
...
| `ARENATESTBED_VERSION` | **6.1.1** | Fix iaThinking preso em true + cleanup V2: remove addLog/addBalao/remainingMove/getPoderesPorId, defensePending.opcoes vindo do engine |
