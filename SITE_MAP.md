...
| `/games/pesadelo` | PP | `src/pages/PesadeloParticular/PP.jsx` | 🔄 QA v1.5.4 | Pesadelo Particular — 20 casos, Supabase save, puzzles reais, combate, i18n — **EM FASE DE QUALIDADE** |
