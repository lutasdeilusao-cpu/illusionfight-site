...
| `/extras/ldi-arena` | ArenaRoute | `src/pages/Arena/ArenaRoute.jsx` | ✅ v1.6.5 | LDI Arena Mode — criação de ficha + combate CPU standalone com progressão de inimigos |
...
### LDI Arena Mode
**Status:** ✅ v1.6.5 implementado
**Console:** `[ARENA] versão carregada: 1.6.5`
