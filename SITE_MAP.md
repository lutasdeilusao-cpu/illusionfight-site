...
|---|---|---|
| `SITE_VERSION` | **10.156.23** | Site — UX bottom-nav hint fade + balão MISS + fix dano interpolação Phase3 |
...
| `ARENATESTBED_VERSION` | **1.10.24** | Arena Testbed — UX bottom-nav hint fade + balão MISS + fix dano interpolação |
