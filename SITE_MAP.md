...
|---|---|---|
| `SITE_VERSION` | **10.142.0** | Site — canvas resize no useEffect, draw só desenha |
...
| `ARENATESTBED_VERSION` | **1.7.0** | Arena Testbed — canvas resize no useEffect, draw só desenha |
