...
*Versão: 1.72*  |  `[SITE] versão carregada: 1.72`
...
| `/games/tamagoshi` | Tamagoshi | `src/pages/Tamagoshi/Tamagoshi.jsx` | ✅ v1.6.3 | Tamagoshi LDI — ciclo de vida completo, DIX economy, loja, 3 minigames, Hall da Fama |

**Versão atual:** `1.6.3` (console: `[TAMA] versão carregada: 1.6.3`)
