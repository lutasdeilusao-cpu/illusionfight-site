...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-30 — v10.192.47 (reconciliação resiliente da fila pública do Top Trumps MP)
...
|---|---|---|
| `SITE_VERSION` | **10.192.47** | Reconciliação resiliente da fila pública do Top Trumps MP |
...
| `TM_VERSION` | **5.12.3** | Top Trumps MP — reconciliação resiliente da fila pública |
