...
|---|---|---|
| `SITE_VERSION` | **10.98.1** | Site — fix hasWallBetween (comparação por coordenada em vez de índice) |
...
| `PROTOTYPE_VERSION` | **2.3.1** | Protótipo — Arena Testbed: fix hasWallBetween (comparação por coordenada em vez de índice) |
