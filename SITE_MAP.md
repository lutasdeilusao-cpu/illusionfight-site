...
*Versão: 10.0.3*  |  `[SITE] versão carregada: 10.0.3`  |  🌐 **`https://illusionfight.com/`** (domínio oficial)  |  🐛 debug: logs [NINA] em todo o fluxo + notificação após 3s para diagnóstico
