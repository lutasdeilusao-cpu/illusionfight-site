...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-30 — v10.192.55 (reconciliação canônica da fila pública do Top Trumps MP)
...
|---|---|---|
| `SITE_VERSION` | **10.192.55** | Reconciliação canônica da fila pública do Top Trumps MP |
...
| `TM_VERSION` | **5.12.11** | Top Trumps MP — reconciliação canônica da fila pública |
