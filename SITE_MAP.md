...
|---|---|---|
| `SITE_VERSION` | **10.179.4** | CSV restructured: proper quoting, country normalized, 460 contacts |
...
| `TS_VERSION` | **5.37.2** | Top Trumps SP — sound toggle position fixed no topo, sem overlap |
