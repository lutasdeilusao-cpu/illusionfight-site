...
| `/games/tamagoshi` | Tamagoshi | `src/pages/Tamagoshi/Tamagoshi.jsx` | ✅ v1.1.2 | Tamagoshi LDI — criatura virtual com personalidade, decaimento em tempo real, Supabase save |
...
**Versão atual:** `1.1.2` (console: `[TAMA] versão carregada: 1.1.2`)
