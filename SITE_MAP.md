...
|---|---|---|
| `SITE_VERSION` | **10.117.0** | Site — Protótipo: fix hexCorners flat-top + COLORS LDI + closure stale handlers + glow |
...
| `PROTOTYPE_VERSION` | **4.7.0** | Protótipo — Arena Testbed: fix hexCorners flat-top + COLORS LDI + closure stale handlers + glow |
