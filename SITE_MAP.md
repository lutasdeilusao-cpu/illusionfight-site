...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-30 — v10.192.52 (turno autoritativo do Top Trumps MP)
...
|---|---|---|
| `SITE_VERSION` | **10.192.52** | Turno autoritativo do Top Trumps MP |
...
| `TM_VERSION` | **5.12.8** | Top Trumps MP — turno derivado do estado autoritativo da sala |
