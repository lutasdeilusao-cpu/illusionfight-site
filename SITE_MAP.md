...
| `/games/toptrumps` | TopTrumps | `src/pages/games/TopTrumps/TopTrumps.jsx` | ✅ v5.39.1 | ✅ 1ª temp. ✅ Deck Build | ✅ PT ✅ EN ✅ ES | useSwipe pointer events: funciona em desktop e mobile |
...
|---|---|---|
| `SITE_VERSION` | **10.179.7** | useSwipe pointer events — funciona em desktop e mobile |
...
| `TS_VERSION` | **5.39.1** | Top Trumps SP — useSwipe pointer events: funciona em desktop e mobile |
