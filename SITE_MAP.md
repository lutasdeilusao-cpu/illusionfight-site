...
|---|---|---|
| `SITE_VERSION` | **10.156.88** | Arena: modal unificado de escolha de poder atq/def |
...
| `ARENATESTBED_VERSION` | **4.0.0** | Modal unificado de escolha de poder — ataque e defesa |
