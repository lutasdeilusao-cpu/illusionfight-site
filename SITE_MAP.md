...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-02
...
|---|---|---|
| `SITE_VERSION` | **10.183.33** | feat: toggle Games LDI / Kernel Panic com estética hacker — aba temática separada com placeholder vazio, i18n PT/EN/ES, CSS modular sem contaminação |
