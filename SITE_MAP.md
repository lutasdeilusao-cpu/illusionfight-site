...
|---|---|---|
| `SITE_VERSION` | **10.157.38** | Corrige HP race condition: duplo applyDanoEffect acumulado em danoTotal |
...
| `ARENATESTBED_VERSION` | **5.15.4** | Corrige HP race condition: duplo applyDanoEffect acumulado em danoTotal |
