...
|---|---|---|
| `SITE_VERSION` | **10.158.12** | Investigação: logs TC-01 a TC-16 iaThinking durante turno jogador |
...
| `ARENATESTBED_VERSION` | **6.3.7** | Investigação: logs TC-01 a TC-16 iaThinking durante turno jogador |
