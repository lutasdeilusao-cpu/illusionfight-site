...
|---|---|---|
| `SITE_VERSION` | **10.183.6** | PR outreach +338 contatos INT (Spanish, Asian, English markets) |
...
| `TS_VERSION` | **5.44.5** | Top Trumps SP v2 — fix: reward test card images + prerender rotas |
