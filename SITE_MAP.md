...
|---|---|---|
| `SITE_VERSION` | **10.101.1** | Site — Arena Testbed: fixes floaters travados + fluxo turno livre + IA range visual |
...
| `PROTOTYPE_VERSION` | **2.5.2** | Protótipo — Arena Testbed: fixes floaters travados + fluxo turno livre + IA range visual |
