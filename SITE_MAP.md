...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-30 — v10.192.49 (serialização das rodadas do Top Trumps MP)
...
|---|---|---|
| `SITE_VERSION` | **10.192.49** | Serialização das rodadas do Top Trumps MP |
...
| `TM_VERSION` | **5.12.5** | Top Trumps MP — serialização da transição entre rodadas |
