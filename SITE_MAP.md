...
|---|---|---|
| `SITE_VERSION` | **10.156.4** | Site — recalc usa getBoundingClientRect para medir canvas |
...
| `ARENATESTBED_VERSION` | **1.10.4** | Arena Testbed — recalc usa getBoundingClientRect para medir canvas |
