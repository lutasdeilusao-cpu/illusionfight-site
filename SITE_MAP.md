...
|---|---|---|
| `SITE_VERSION` | **10.160.7** | fix: onClearHighlight em cancelarAcao + v10.160.7 |
...
| `ARENATESTBED_VERSION` | **6.9.4** | fix: onClearHighlight em cancelarAcao + limpeza síncrona highlightRef |
