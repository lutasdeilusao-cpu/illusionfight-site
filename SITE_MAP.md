...
|---|---|---|
| `SITE_VERSION` | **10.176.0** | Fix: layout jogando v3 — botão som dentro container + VS glow ativado + mini card 240px + VS margin-top:auto |
...
| `TS_VERSION` | **5.34.0** | Top Trumps SP — fix jogando v3: botão som dentro container + VS glow ativado + mini card 240px + VS margin-top:auto |
