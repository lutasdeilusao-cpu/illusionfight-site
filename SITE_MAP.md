...
|---|---|---|
| `SITE_VERSION` | **10.156.28** | deploy consolidado ARENATESTBED 1.10.29 |
...
| `ARENATESTBED_VERSION` | **1.10.29** | Phase3Combat — novo sistema ordenação turno (4 etapas) + AGI 1:1 oficial |
