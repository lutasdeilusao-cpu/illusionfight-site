...
> Atualizado em 2026-08-01 — `SITE_VERSION` **10.192.83**.
...
- Migrações locais: `supabase/migrations/004_*.sql` até `023_admin_reset_achievements.sql`; os números podem se repetir porque algumas linhas de evolução foram criadas em paralelo.
