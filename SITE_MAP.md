...
|---|---|---|
| `SITE_VERSION` | **10.156.96** | Arena: fix IA pulando idx + disparo duplicado — turno unificado |
...
| `ARENATESTBED_VERSION` | **5.2.2** | Fix IA pulando idx + disparo duplicado — turno unificado skip mortos |
