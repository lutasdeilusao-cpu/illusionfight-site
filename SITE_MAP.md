...
| `/extras/jackcandy` | JackCandy | `src/pages/JackCandy/JackCandy.jsx` | ✅ v4.0.13 | Jack Dream Beer — idle noir investigativo |
...
**Stack:** React 19 · Zustand · Framer Motion · Supabase  
**Versão atual:** `4.0.13` (console: `[JACK] versão carregada: 4.0.13`)  
