...
|---|---|---|
| `SITE_VERSION` | **10.104.0** | Site — Arena Testbed: fix pathfinding personagens + highlight destino + canvas mobile |
...
| `PROTOTYPE_VERSION` | **2.8.0** | Protótipo — Arena Testbed: fix pathfinding personagens + highlight destino + canvas mobile |
