...
*Versão: 8.3*  |  `[SITE] versão carregada: 8.3`  |  🌐 **`https://illusionfight.com/`** (domínio oficial)
*Versão: 8.3*  |  `[SITE] versão carregada: 8.3`  |  🌐 **`https://illusionfight.com/`** (domínio oficial)
*TATICS versão: 7.0.0* | `[TATICS] versão carregada: 7.0.0`
*MP versão: 4.0.3* | `[MP] versão carregada: 4.0.3`
...
| `/games/toptrumps` | TopTrumps | `src/pages/TopTrumps.jsx` | ✅ v4.0.3 | ✅ 1ª temp. | ✅ PT ✅ EN ✅ ES | Cartas colecionáveis, deck, recompensa diária |
