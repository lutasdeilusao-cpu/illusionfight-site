...
|---|---|---|
| `SITE_VERSION` | **10.156.3** | Site — recalc usa canvas.clientWidth/Height em vez de parent |
...
| `ARENATESTBED_VERSION` | **1.10.3** | Arena Testbed — recalc usa canvas.clientWidth/Height em vez de parent |
