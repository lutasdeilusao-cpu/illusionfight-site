...
*Versão: 1.82*  |  `[SITE] versão carregada: 1.82`
...
| `/games/tamagoshi` | Tamagoshi | `src/pages/Tamagoshi/Tamagoshi.jsx` | ✅ v1.8.5 | Tamagoshi LDI — ciclo de vida completo, DIX economy, loja, 3 minigames, Hall da Fama |

**Versão atual:** `1.8.5` (console: `[TAMA] versão carregada: 1.8.5`)
