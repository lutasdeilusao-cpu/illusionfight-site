...
*Versão: 1.74*  |  `[SITE] versão carregada: 1.74`
...
| `/games/tamagoshi` | Tamagoshi | `src/pages/Tamagoshi/Tamagoshi.jsx` | ✅ v1.6.5 | Tamagoshi LDI — ciclo de vida completo, DIX economy, loja, 3 minigames, Hall da Fama |

**Versão atual:** `1.6.5` (console: `[TAMA] versão carregada: 1.6.5`)
