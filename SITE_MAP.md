...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-27 — v10.192.39 (VS do Top Trumps centralizado entre as cartas)
...
| `/games/toptrumps` | TopTrumpsSP | `src/pages/games/TopTrumps/TopTrumpsSP.jsx` | ✅ v5.44.16 | ✅ 1ª temp. ✅ Deck Build | ✅ PT ✅ EN ✅ ES | Versão oficial; VS centralizado entre as cartas |
| `/games/toptrumps/v2` | TopTrumpsSP | `src/pages/games/TopTrumps/TopTrumpsSP.jsx` | ✅ v5.44.16 | ✅ 1ª temp. ✅ Deck Build | ✅ PT ✅ EN ✅ ES | Alias para /games/toptrumps; CSS modular |
...
|---|---|---|
| `SITE_VERSION` | **10.192.39** | VS do Top Trumps centralizado entre as cartas |
...
| `TS_VERSION` | **5.44.16** | Top Trumps — VS centralizado entre as cartas |
