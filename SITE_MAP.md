...
|---|---|---|
| `SITE_VERSION` | **10.156.18** | Site — fix: hex col-offset + balões + confirm movimento + css cleanup Phase3 |
...
| `ARENATESTBED_VERSION` | **1.10.18** | Arena Testbed — fix: hex col-offset + balões + confirm movimento + css cleanup |
