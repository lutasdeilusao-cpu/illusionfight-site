...
| `/extras/ldi-arena` | ArenaRoute | `src/pages/Arena/ArenaRoute.jsx` | ✅ v1.4.4 | LDI Arena Mode — criação de ficha + combate CPU standalone |
...
### LDI Arena Mode
**Status:** ✅ v1.4.4 implementado
**Console:** `[ARENA] versão carregada: 1.4.4`
