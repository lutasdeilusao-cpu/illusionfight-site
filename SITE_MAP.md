...
|---|---|---|
| `SITE_VERSION` | **10.116.0** | Site — Protótipo: fix Phase3 Pixi loading overlay + retry + Phase2 hexSize dinâmico |
...
| `PROTOTYPE_VERSION` | **4.6.0** | Protótipo — Arena Testbed: fix Phase3 Pixi loading overlay + retry + Phase2 hexSize dinâmico |
