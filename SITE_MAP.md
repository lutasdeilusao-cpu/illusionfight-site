...
|---|---|---|
| `SITE_VERSION` | **10.165.0** | fix PPT — traduções, layout mobile empilhado, revelação simultânea |
...
| `TS_VERSION` | **5.27.0** | Top Trumps SP — fix PPT: traduções, layout mobile, revelação simultânea |
