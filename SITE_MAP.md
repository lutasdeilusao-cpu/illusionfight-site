...
*Versão: 9.109*  |  `[SITE] versão carregada: 9.109`  |  🌐 **`https://illusionfight.com/`** (domínio oficial)  |  ✅ Arena v1.14.1 — Nova Ficha: botão Voltar na tela de introdução
...
*ARENA versão: 1.14.1* | `[ARENA] versão carregada: 1.14.1` (Nova Ficha: botão Voltar na tela de introdução)
