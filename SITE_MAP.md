...
|---|---|---|
| `SITE_VERSION` | **10.177.0** | Fix: VS glow intensidade + mini card altura 238px (preenche até botão) |
...
| `TS_VERSION` | **5.35.0** | Top Trumps SP — VS glow intensidade + mini card altura 238px (preenche até botão) |
