...
*Versão: 1.57*  |  `[SITE] versão carregada: 1.57`
...
| `/games/pesadelo` | PP | `src/pages/PesadeloParticular/PP.jsx` | ✅ i18n v1.5.20 | Pesadelo Particular — 20 casos, Supabase save, puzzles reais, combate, **i18n completa: todas as strings migradas para pp-i18n.js** |
