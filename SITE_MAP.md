...
|---|---|---|
| `SITE_VERSION` | **10.183.2** | TopTrumps v2 — fix: perfil not defined in useTopTrumpsRewards |
...
| `TS_VERSION` | **5.44.2** | Top Trumps SP v2 — fix: perfil not defined in useTopTrumpsRewards |
