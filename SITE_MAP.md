...
| `/games/tamagoshi` | Tamagoshi | `src/pages/Tamagoshi/Tamagoshi.jsx` | ✅ v1.28.0 | ✅ Múltiplos slots + hibernação | ✅ PT ✅ EN ✅ ES | Tamagotchi: lazy eval + decay em sessão + SFX + i18n completo pt/en/es |
...
|---|---|---|
| `SITE_VERSION` | **10.7.0** 🚀 | Site — Tamagoshi: múltiplos slots + hibernação |
...
| `TAMA_VERSION` | **1.28.0** | Tamagoshi LDI — múltiplos slots + hibernação |
