...
|---|---|---|
| `SITE_VERSION` | **10.156.92** | Arena: remover anúncios redundantes + balão dano duplicado |
...
| `ARENATESTBED_VERSION` | **5.0.2** | Remover anúncios redundantes + balão de dano duplicado |
