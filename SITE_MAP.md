...
| `/games/minigames` | MiniGames | `src/pages/MiniGames/MiniGames.jsx` | ✅ **v3.0.2** | ✅ **100%** | ✅ PT ✅ EN ✅ ES | 8 puzzles arcade, todos os níveis free |
...
|---|---|---|
| `SITE_VERSION` | **10.156.56** | MiniGames: Back dentro do jogo retorna para seleção de dificuldade |
...
| `MINIGAMES_VERSION` | **3.0.2** | Back dentro do jogo retorna para seleção de dificuldade |
