...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-01
...
|---|---|---|
| `SITE_VERSION` | **10.183.25** | fix: i18n path mismatch ModalLancamento (site.modal_lancamento → site.games.modal_lancamento) + hardcoded ATAQUE EnemyTurnBanner |
