...
*Versão: 10.0.4*  |  `[SITE] versão carregada: 10.0.4`  |  🌐 **`https://illusionfight.com/`** (domínio oficial)  |  🐛 fix: Nina agora ignora o notificationManager queue completamente — mostra direto sem ficar presa atrás de ldi_tip
