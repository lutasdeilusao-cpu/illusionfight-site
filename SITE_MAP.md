...
|---|---|---|
| `SITE_VERSION` | **10.158.11** | Fix: executarAtaque passa onFinalizar para animação do jogador |
...
| `ARENATESTBED_VERSION` | **6.3.6** | Fix: executarAtaque passa onFinalizar para animação do jogador |
