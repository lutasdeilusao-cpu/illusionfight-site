...
|---|---|---|
| `SITE_VERSION` | **10.156.6** | Site — recalc desconta bordas do canvas na medição |
...
| `ARENATESTBED_VERSION` | **1.10.6** | Arena Testbed — recalc desconta bordas do canvas na medição |
