...
|---|---|---|
| `SITE_VERSION` | **10.158.15** | Fix: spinner IA durante turno jogador + TypeError row undefined projétil |
...
| `ARENATESTBED_VERSION` | **6.4.0** | Fix: spinner IA durante turno jogador + TypeError row undefined projétil |
