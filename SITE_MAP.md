...
|---|---|---|
| `SITE_VERSION` | **10.183.14** | YouTube creators outreach: +142 INT +84 BR (Ásia/África/Europa/LATAM) |
...
| `TS_VERSION` | **5.45.2** | Top Trumps — fix: VS deslocado para baixo (flex layout) |
