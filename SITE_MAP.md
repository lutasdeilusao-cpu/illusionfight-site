...
|---|---|---|
| `SITE_VERSION` | **10.156.1** | Site — Phase2: maxSz 60 + padY centralizado de volta |
...
| `ARENATESTBED_VERSION` | **1.10.1** | Arena Testbed — Phase2: maxSz 60 + padY centralizado de volta |
