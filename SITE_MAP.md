...
|---|---|---|
| `SITE_VERSION` | **10.158.14** | Investigação: logs VIS-01/02 quando banner iaThinking aparece visualmente |
...
| `ARENATESTBED_VERSION` | **6.3.9** | Investigação: logs VIS-01/02 quando banner iaThinking aparece visualmente |
