...
|---|---|---|
| `SITE_VERSION` | **10.180.0** | Top Trumps: arrow button absolute positioned as circle |
...
| `TS_VERSION` | **5.39.4** | Top Trumps SP — arrow button absolute positioned as circle at 15px lateral |
