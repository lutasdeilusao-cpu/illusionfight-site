...
|---|---|---|
| `SITE_VERSION` | **10.158.0** | Task 6: limpeza final Phase6, zero duplicatas |
...
| `ARENATESTBED_VERSION` | **6.0.0** | Task 6: limpeza final Phase6, zero duplicatas, refs removidas, JSX redirecionado para engine.actions.* |
