...
| `/games/minigames` | MiniGames | `src/pages/MiniGames/MiniGames.jsx` | ✅ **v3.0.1** | ✅ **100%** | ✅ PT ✅ EN ✅ ES | 8 puzzles arcade, todos os níveis free |
...
|---|---|---|
| `SITE_VERSION` | **10.156.55** | Simon Says: feedback visual do jogador em todos os níveis |
...
| `MINIGAMES_VERSION` | **3.0.1** | Simon Says: feedback visual do jogador em todos os níveis |
