...
|---|---|---|
| `SITE_VERSION` | **10.99.0** | Site — Arena Testbed: fix ataque melee jogador + animação IA + projétil célula a célula |
...
| `PROTOTYPE_VERSION` | **2.4.0** | Protótipo — Arena Testbed: fix ataque melee jogador + animação IA + projétil célula a célula |
