...
|---|---|---|
| `SITE_VERSION` | **10.110.0** | Site — Arena Testbed redesign: identidade LDI Arena herdada |
...
| `PROTOTYPE_VERSION` | **4.0.0** | Protótipo — Arena Testbed: redesign visual herdando identidade LDI Arena (Courier/Rajdhani, #F5A623/#00B4D8/#8B0000) |
