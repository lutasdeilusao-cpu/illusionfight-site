...
|---|---|---|
| `SITE_VERSION` | **10.159.9** | feat: useEffectMachine v1 — estrutura base + EffectRenderer + effectsMap |
...
| `ARENATESTBED_VERSION` | **6.7.0** | feat: useEffectMachine v1 — estrutura base + EffectRenderer + effectsMap |
