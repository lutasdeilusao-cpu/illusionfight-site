...
|---|---|---|
| `SITE_VERSION` | **10.148.0** | Site — canvas preenche container, grid centralizado |
...
| `ARENATESTBED_VERSION` | **1.8.5** | Arena Testbed — canvas preenche container, grid centralizado |
