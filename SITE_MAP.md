...
|---|---|---|
| `SITE_VERSION` | **10.118.0** | Site — Protótipo: visual completo Canvas 2D + CSS + balões dano Ragnarok v5.0.0 |
...
| `PROTOTYPE_VERSION` | **5.0.0** | Protótipo — Arena Testbed: visual completo Canvas 2D + CSS + balões dano Ragnarok v5.0.0 |
