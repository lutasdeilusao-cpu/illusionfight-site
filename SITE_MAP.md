...
|---|---|---|
| `SITE_VERSION` | **10.160.36** | FEAT: overlay DOM via EffectRenderer + EventBus + ImpactoEffect neon |
...
| `ARENATESTBED_VERSION` | **6.19.0** | FEAT: overlay DOM via EffectRenderer + EventBus + ImpactoEffect neon |
