...
|---|---|---|
| `SITE_VERSION` | **10.163.8** | fix: centralização vertical mobile-first Top Trumps + resolução conflitos CSS |
...
| `TS_VERSION` | **5.25.2** | Top Trumps SP — centralização vertical mobile-first + resolução conflitos CSS |
