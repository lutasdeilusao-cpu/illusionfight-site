...
*Versão: 1.79*  |  `[SITE] versão carregada: 1.79`
...
| `/games/tamagoshi` | Tamagoshi | `src/pages/Tamagoshi/Tamagoshi.jsx` | ✅ v1.8.2 | Tamagoshi LDI — ciclo de vida completo, DIX economy, loja, 3 minigames, Hall da Fama |

**Versão atual:** `1.8.2` (console: `[TAMA] versão carregada: 1.8.2`)
