...
|---|---|---|
| `SITE_VERSION` | **10.160.8** | fix: highlight hexagonal branco + verificação limpeza síncrona |
...
| `ARENATESTBED_VERSION` | **6.9.5** | fix: highlight hexagonal branco + verificação limpeza síncrona |
