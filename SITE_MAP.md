...
|---|---|---|
| `SITE_VERSION` | **10.128.0** | Site — Phase3 ataque subPhase fix + centralização canvas |
...
| `ARENATESTBED_VERSION` | **1.2.0** | Arena Testbed — fix: ataque subPhase bug + centralização canvas |
