...
|---|---|---|
| `SITE_VERSION` | **10.158.4** | Criar useUIController + separar responsabilidades do V2 |
...
| `ARENATESTBED_VERSION` | **6.2.0** | Criar useUIController + separar responsabilidades do V2 |
