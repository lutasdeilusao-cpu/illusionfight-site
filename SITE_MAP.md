...
|---|---|---|
| `SITE_VERSION` | **10.157.41** | Task 5: callbacks visuais IA completos, executarIA removido do Phase6 |
...
| `ARENATESTBED_VERSION` | **5.17.0** | Task 5: callbacks visuais IA completos, executarIA removido do Phase6 |
