...
|---|---|---|
| `SITE_VERSION` | **10.160.37** | FIX: movement animations visual-only steps (V1+V2) |
...
| `ARENATESTBED_VERSION` | **6.20.0** | FIX: movement animations visual-only steps (V1+V2), syncCharacters só no último step |
