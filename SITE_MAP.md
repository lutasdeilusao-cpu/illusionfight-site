...
| `/extras/jackcandy` | JackCandy | `src/pages/JackCandy/JackCandy.jsx` | ✅ v5.1.0 | Jack Dream Beer — idle noir investigativo |
...
**Stack:** React 19 · Zustand · Framer Motion · Supabase  
**Versão atual:** `5.1.0` (console: `[JACK] versão carregada: 5.1.0`)  
