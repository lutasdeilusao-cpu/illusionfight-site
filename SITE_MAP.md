...
|---|---|---|
| `SITE_VERSION` | **10.159.8** | Fix: PowerChoiceModal opcoes formatadas + ataque comum |
...
| `ARENATESTBED_VERSION` | **6.6.1** | Fix: PowerChoiceModal opcoes formatadas + ataque comum |
