...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-27 — v10.192.32 (30 artes oficiais do Top Trumps conectadas)
...
| `/games/toptrumps` | TopTrumpsSP_v2 | `src/pages/games/TopTrumps/v2/TopTrumpsSP_v2.jsx` | ✅ v5.44.12 | ✅ 1ª temp. ✅ Deck Build | ✅ PT ✅ EN ✅ ES | v2 com as 30 artes oficiais conectadas |
| `/games/toptrumps/v2` | TopTrumpsSP_v2 | `src/pages/games/TopTrumps/v2/TopTrumpsSP_v2.jsx` | ✅ v5.44.12 | ✅ 1ª temp. ✅ Deck Build | ✅ PT ✅ EN ✅ ES | Alias para /games/toptrumps; CSS modular |
| `/games/toptrumps/v2/reward-test` | TopTrumpsSP_v2_RewardTest | `src/pages/games/TopTrumps/v2/TopTrumpsSP_v2_RewardTest.jsx` | ✅ v5.44.12 | ✅ Teste de recompensa | ✅ PT ✅ EN ✅ ES | Tela de recompensa isolada para testes |
...
|---|---|---|
| `SITE_VERSION` | **10.192.32** | 30 artes oficiais do Top Trumps conectadas |
