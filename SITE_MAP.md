...
| `/games/minigames` | MiniGames | `src/pages/MiniGames/MiniGames.jsx` | ✅ **v4.0.0** | ✅ **100%** | ✅ PT ✅ EN ✅ ES | 8 puzzles arcade, todos os níveis free |
...
|---|---|---|
| `SITE_VERSION` | **10.156.58** | MiniGames: limpar logs + Labirinto perseguidor |
...
| `MINIGAMES_VERSION` | **4.0.0** | Labirinto: perseguidor (policial) + limpar console.logs |
