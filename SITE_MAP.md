...
|---|---|---|
| `SITE_VERSION` | **10.156.22** | Site — múltiplas melhorias Phase3: end-turn bottom, agi default, crit balão, logs, HEX cleanup |
...
| `ARENATESTBED_VERSION` | **1.10.23** | Arena Testbed — múltiplas melhorias: end-turn bottom, agi default, crit balão, logs, HEX cleanup |
