...
|---|---|---|
| `SITE_VERSION` | **10.160.32** | INV: juice system — diagnostic logs for visual effects investigation |
...
| `ARENATESTBED_VERSION` | **6.18.1** | INV: juice system — diagnostic logs for visual effects investigation |
