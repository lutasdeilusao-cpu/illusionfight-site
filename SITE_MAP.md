...
|---|---|---|
| `SITE_VERSION` | **10.140.0** | Site — canvas sem style inline, CSS puro + custom properties |
...
| `ARENATESTBED_VERSION` | **1.6.8** | Arena Testbed — canvas sem style inline, CSS puro + custom properties |
