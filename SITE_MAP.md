...
|---|---|---|
| `SITE_VERSION` | **10.156.94** | Arena: poder Investida — ataque em linha N/S |
...
| `ARENATESTBED_VERSION` | **5.2.0** | Poder Investida — ataque em linha N/S com preview interativo e dano escalonado |
