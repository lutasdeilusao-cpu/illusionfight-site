...
|---|---|---|
| `SITE_VERSION` | **10.102.2** | Site — Arena Testbed: fix Phase3Combat: setPhase(null) em startPlayerTurn jogador |
...
| `PROTOTYPE_VERSION` | **2.6.2** | Protótipo — Arena Testbed: fix Phase3Combat: setPhase(null) em startPlayerTurn jogador |
