...
| `/extras/jackcandy` | JackCandy | `src/pages/JackCandy/JackCandy.jsx` | ✅ v4.0.17 | Jack Dream Beer — idle noir investigativo |
...
**Stack:** React 19 · Zustand · Framer Motion · Supabase  
**Versão atual:** `4.0.17` (console: `[JACK] versão carregada: 4.0.17`)  
