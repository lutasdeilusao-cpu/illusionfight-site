...
*Versão: 2.07*  |  `[SITE] versão carregada: 2.07`
...
| `/games/ldi-tatics` | ArenaTaticsRoute | `src/pages/ArenaTatics/ArenaTaticsRoute.jsx` | ✅ v2.8.0 | LDI TATICS — sistema de classes Ragnarok, grid 8×16, 3v3 tático por turnos, árvore de evolução — **1ª temporada** |
