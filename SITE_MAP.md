...
|---|---|---|
| `SITE_VERSION` | **10.115.0** | Site — Protótipo: fix Phase3 Pixi init (useLayoutEffect + try/catch + log null ref) |
...
| `PROTOTYPE_VERSION` | **4.5.0** | Protótipo — Arena Testbed: fix Phase3 Pixi init (useLayoutEffect + try/catch + log null ref) |
