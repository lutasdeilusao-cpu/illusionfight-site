...
|---|---|---|
| `SITE_VERSION` | **10.152.0** | Site — refactor: useHexCanvas hook + Phase2 i18n + Phase3 remove enterSubPhase dup |
...
| `ARENATESTBED_VERSION` | **1.8.9** | Arena Testbed — refactor: useHexCanvas hook + Phase2 i18n + Phase3 remove enterSubPhase dup |
