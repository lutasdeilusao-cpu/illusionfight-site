...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-28 — v10.192.41 (atributos traduzidos e safe-area no Arena Report)
...
| `/games/toptrumps` | TopTrumpsSP | `src/pages/games/TopTrumps/TopTrumpsSP.jsx` | ✅ v5.44.18 | ✅ 1ª temp. ✅ Deck Build | ✅ PT ✅ EN ✅ ES | Versão oficial; atributos traduzidos e safe-area no Arena Report |
| `/games/toptrumps/v2` | TopTrumpsSP | `src/pages/games/TopTrumps/TopTrumpsSP.jsx` | ✅ v5.44.18 | ✅ 1ª temp. ✅ Deck Build | ✅ PT ✅ EN ✅ ES | Alias para /games/toptrumps; CSS modular |
...
|---|---|---|
| `SITE_VERSION` | **10.192.41** | Atributos traduzidos e safe-area no Arena Report |
...
| `TS_VERSION` | **5.44.18** | Top Trumps — atributos traduzidos e safe-area no Arena Report |
