...
|---|---|---|
| `SITE_VERSION` | **10.181.1** | TopTrumps: touch-action manipulation nos atributos clicáveis |
...
| `TS_VERSION` | **5.40.1** | Top Trumps SP — touch-action manipulation + user-select none nos atributos |
