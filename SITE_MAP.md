...
| `/games/minigames` | MiniGames | `src/pages/MiniGames/MiniGames.jsx` | ✅ **v4.0.1** | ✅ **100%** | ✅ PT ✅ EN ✅ ES | 8 puzzles arcade, todos os níveis free |
...
|---|---|---|
| `SITE_VERSION` | **10.156.59** | MiniGames Labirinto: fix alarme not a function |
...
| `MINIGAMES_VERSION` | **4.0.1** | Labirinto: fix alarme is not a function |
