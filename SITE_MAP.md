...
|---|---|---|
| `SITE_VERSION` | **10.156.95** | Arena: fix crash ordenação + lógica de turno por AGI |
...
| `ARENATESTBED_VERSION` | **5.2.1** | Fix crash 'bloco is not defined' + lógica de ordenação de turno por AGI |
