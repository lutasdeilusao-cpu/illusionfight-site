...
|---|---|---|
| `SITE_VERSION` | **10.160.1** | feat: primitivos visuais v1 — Trail/Melee/Projetil/Highlight com visual real |
...
| `ARENATESTBED_VERSION` | **6.9.0** | feat: primitivos visuais v1 — Trail/Melee/Projetil/Highlight com visual real |
