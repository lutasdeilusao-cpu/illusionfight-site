...
|---|---|---|
| `SITE_VERSION` | **10.160.12** | fix: remover dispatchEffect highlight do useEffect — canal canvas livre para projetil da IA |
...
| `ARENATESTBED_VERSION` | **6.9.9** | fix: remover dispatchEffect highlight do useEffect — canal canvas livre para projetil da IA |
