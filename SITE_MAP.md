...
|---|---|---|
| `SITE_VERSION` | **10.113.0** | Site — Arena Testbed: diagnóstico canvas Phase3 + HEX_SIZE compacto Phase2 |
...
| `PROTOTYPE_VERSION` | **4.3.0** | Protótipo — Arena Testbed: diagnóstico canvas Phase3 + HEX_SIZE compacto Phase2 |
