...
|---|---|---|
| `SITE_VERSION` | **10.160.21** | FEAT: sistema animacoes ficha + Phase5bAnimDebug [DEBUG] |
...
| `ARENATESTBED_VERSION` | **6.12.1** | FEAT: sistema animacoes ficha + Phase5bAnimDebug [DEBUG] |
