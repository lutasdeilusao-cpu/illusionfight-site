...
|---|---|---|
| `SITE_VERSION` | **10.179.6** | Fix: card tamanho único mobile em qualquer viewport, media queries removidos |
...
| `TS_VERSION` | **5.39.0** | Top Trumps SP — card tamanho único mobile em qq viewport, MQs removidos |
