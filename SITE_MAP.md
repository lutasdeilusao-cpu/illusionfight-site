...
|---|---|---|
| `SITE_VERSION` | **10.181.5** | TopTrumps: transform-origin top left no swipe card template |
...
| `TS_VERSION` | **5.40.4** | Top Trumps SP — transform-origin top left no swipe card template |
