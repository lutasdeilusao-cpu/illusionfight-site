...
|---|---|---|
| `SITE_VERSION` | **10.158.6** | Investigação: logs ATK-EXTRA em handleAtaqueExtra/finalizarAposAtaque |
...
| `ARENATESTBED_VERSION` | **6.3.1** | Investigação: logs ATK-EXTRA em handleAtaqueExtra/finalizarAposAtaque |
