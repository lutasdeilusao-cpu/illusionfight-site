...
| `/games/toptrumps` | TopTrumpsSP | `src/pages/games/TopTrumps/TopTrumpsSP.jsx` | ✅ v5.45.1 | ✅ 1ª temp. ✅ Deck Build | ✅ PT ✅ EN ✅ ES | Ajuste fino: atributo traduzido + VS centralizado |
...
|---|---|---|
| `SITE_VERSION` | **10.183.11** | TopTrumps — ajuste fino: atributo traduzido, GameOverScreen safe-area, VS centralizado |
...
| `TS_VERSION` | **5.45.1** | Top Trumps — ajuste fino: atributo traduzido, GameOverScreen safe-area, VS centralizado |
