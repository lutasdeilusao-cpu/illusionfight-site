...
|---|---|---|
| `SITE_VERSION` | **10.178.0** | Fix: botão som centralizado topo + mini card scale 0.50 (360px) |
...
| `TS_VERSION` | **5.36.0** | Top Trumps SP — botão som centralizado topo + mini card scale 0.50 (360px) |
