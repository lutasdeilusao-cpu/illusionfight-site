...
|---|---|---|
| `SITE_VERSION` | **10.158.7** | Investigação ampla: logs INV-01 a INV-15 em executarAtaque/animacao/handleAtaqueExtra/finalizarAposAtaque + V2 |
...
| `ARENATESTBED_VERSION` | **6.3.2** | Investigação ampla: logs INV-01 a INV-15 em executarAtaque/animacao/handleAtaqueExtra/finalizarAposAtaque + V2 |
