...
|---|---|---|
| `SITE_VERSION` | **10.157.36** | Corrige TDZ useInputLock → useCombatEngine, conclui Task 2 de integração |
...
| `ARENATESTBED_VERSION` | **5.15.2** | Corrige TDZ useInputLock → useCombatEngine, conclui Task 2 de integração |
