...
|---|---|---|
| `SITE_VERSION` | **10.181.4** | TopTrumps: remover width/height duplicados no swipe template |
...
| `TS_VERSION` | **5.40.3** | Top Trumps SP — remover width/height duplicados no swipe card template |
