...
> **⚠️ Este documento deve ser mantido atualizado a cada nova task concluída.** Última atualização: 2026-07-31 — v10.192.73 (lobby compartilhado segue a fila oficial sem reaproveitamento local de sala)
...
| `/games/toptrumps/multiplayer` | TopTrumpsMP | `src/pages/games/TopTrumps/TopTrumpsMP.jsx` | ✅ v5.13.5 | ✅ 🔒 | ✅ PT ✅ EN ✅ ES | Multiplayer funcional; lobby compartilhado segue a RPC e reconciliação oficiais |
...
|---|---|---|
| `SITE_VERSION` | **10.192.73** | Lobby compartilhado remove reutilização local que recuperava sessões fantasmas |
...
| `TM_VERSION` | **5.13.5** | Top Trumps MP — lobby compartilhado não reutiliza sala antiga antes da RPC oficial |
