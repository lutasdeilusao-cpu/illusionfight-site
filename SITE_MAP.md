...
|---|---|---|
| `SITE_VERSION` | **10.160.6** | fix: highlight limpa síncrono via clearHighlight + onClearHighlight no engine |
...
| `ARENATESTBED_VERSION` | **6.9.3** | fix: highlight limpa síncrono via clearHighlight + onClearHighlight no engine |
