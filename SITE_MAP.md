...
|---|---|---|
| `SITE_VERSION` | **10.103.0** | Site — fix dano mínimo 1 + log drawer cronológico |
...
| `PROTOTYPE_VERSION` | **2.7.0** | Protótipo — Arena Testbed: fix dano mínimo 1 + log drawer cronológico |
