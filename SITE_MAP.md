...
| `/extras/ldi-arena` | ArenaRoute | `src/pages/Arena/ArenaRoute.jsx` | ✅ v1.5.3 | LDI Arena Mode — criação de ficha + combate CPU standalone com progressão de inimigos |
...
### LDI Arena Mode
**Status:** ✅ v1.5.3 implementado
**Console:** `[ARENA] versão carregada: 1.5.3`
