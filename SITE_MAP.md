...
|---|---|---|
| `SITE_VERSION` | **10.179.0** | Fix: VS sem margin-top:auto + mini card scale 0.76 (295px, base real) |
...
| `TS_VERSION` | **5.37.0** | Top Trumps SP — VS sem margin-top:auto + mini card scale 0.76 (295px, base real) |
