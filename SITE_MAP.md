...
|---|---|---|
| `SITE_VERSION` | **10.160.9** | chore: bump investigação highlight persistente pós-movimento |
...
| `ARENATESTBED_VERSION` | **6.9.6** | chore: bump investigação highlight persistente pós-movimento |
