...
|---|---|---|
| `SITE_VERSION` | **10.129.0** | Site — remove click log, add verbose board sizing log + ResizeObserver |
...
| `ARENATESTBED_VERSION` | **1.2.1** | Arena Testbed — remove click log, add verbose board sizing log + ResizeObserver |
