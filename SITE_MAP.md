...
|---|---|---|
| `SITE_VERSION` | **10.101.0** | Site — Arena Testbed: fix cálculo FA/FD: d6 ausente + redução distância no dano bruto |
...
| `PROTOTYPE_VERSION` | **2.5.1** | Protótipo — Arena Testbed: fix cálculo FA/FD: d6 ausente + redução distância no dano bruto |
