...
|---|---|---|
| `SITE_VERSION` | **10.160.10** | fix: zerar caminhoEscolhido e destinoEscolhido em aposMovimento e confirmarMovimento |
...
| `ARENATESTBED_VERSION` | **6.9.7** | fix: zerar caminhoEscolhido e destinoEscolhido em aposMovimento e confirmarMovimento |
