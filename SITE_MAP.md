...
|---|---|---|
| `SITE_VERSION` | **10.158.13** | Investigação: logs TC-17 a TC-20 banner iaThinking render |
...
| `ARENATESTBED_VERSION` | **6.3.8** | Investigação: logs TC-17 a TC-20 banner iaThinking render |
