...
|---|---|---|
| `SITE_VERSION` | **10.156.45** | Tamagoshi — feat: falas-criatura pt/en/es separados + getFala por locale |
...
| `TAMA_VERSION` | **3.1.0** | Tamagoshi LDI — feat: falas-criatura pt/en/es separados + getFala por locale |
