...
| `/prototype` | Prototype | `src/pages/Prototype/Prototype.jsx` | ✅ v2.5.2 | ✅ | ✅ PT ✅ EN ✅ ES | Protótipos admin-only: menu de seleção + Morto Engine (bundled via raw import) + Arena Testbed. Arquivos: `Phase5bAnimDebug.jsx/.css` [DEBUG], `engine/animations/movement/` (Standard/Teleport/Slingshot) |
...
|---|---|---|
| `SITE_VERSION` | **10.160.24** | REFACTOR: MovementAnimId enum no registry de animações de movimento |
...
| `ARENATESTBED_VERSION` | **6.13.1** | REFACTOR: MovementAnimId enum no registry de animações de movimento |
