...
|---|---|---|
| `SITE_VERSION` | **10.160.4** | fix: ReferenceError Phase6CombatV2 linha 142 + sourcemap permanente |
...
| `ARENATESTBED_VERSION` | **6.9.1** | fix: ReferenceError TDZ linha 142 — setProjectilePos usado antes de declarado |
