...
*Versão: 1.97*  |  `[SITE] versão carregada: 1.97`
...
| `/games/ldi-tatics` | ArenaTaticsRoute | `src/pages/ArenaTatics/ArenaTaticsRoute.jsx` | ✅ v2.1.1 | LDI TATICS — sistema de classes Ragnarok, grid 6×10, 3v3 tático por turnos, árvore de evolução — **1ª temporada** |
