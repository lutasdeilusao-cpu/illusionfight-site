...
*Versão: 10.36.2*  |  `[SITE] versão carregada: 10.36.2`  |  🌐 **`https://illusionfight.com/`** (domínio oficial)  |  ✅ Tamagoshi v2.0.2 — fix: FichasContext upsert em vez de update para garantir persistência do saldo; saveToCloud salva nome_custom; Perfil mostra nome da criatura
