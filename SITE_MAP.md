...
|---|---|---|
| `SITE_VERSION` | **10.156.12** | Site — fix: padY offset colunas ímpares hexgrid ArenaTestbed |
...
| `ARENATESTBED_VERSION` | **1.10.12** | Arena Testbed — fix: padY offset colunas ímpares (extraBottom compensado) |
