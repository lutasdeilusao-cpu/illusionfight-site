...
|---|---|---|
| `SITE_VERSION` | **10.156.11** | Site — fix: padY vertical centering hexgrid ArenaTestbed |
...
| `ARENATESTBED_VERSION` | **1.10.11** | Arena Testbed — fix: padY vertical centering (gridSpanH em vez de gridH) |
