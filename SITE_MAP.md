...
*Versão: 1.59*  |  `[SITE] versão carregada: 1.59`
...
| `/games/pesadelo` | PP | `src/pages/PesadeloParticular/PP.jsx` | ✅ i18n v1.5.22 | Pesadelo Particular — 20 casos, Supabase save, puzzles reais, combate, **i18n completa** |
