...
|---|---|---|
| `SITE_VERSION` | **10.131.0** | Site — canvas tamanho do grid, centralização via CSS |
...
| `ARENATESTBED_VERSION` | **1.5.0** | Arena Testbed — canvas tamanho do grid, centralização via CSS |
