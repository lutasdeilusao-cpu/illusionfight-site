...
|---|---|---|
| `SITE_VERSION` | **10.156.48** | Tamagoshi — feat: itens saude na loja + verificação inventário + consumo ao concluir |
...
| `TAMA_VERSION` | **3.2.2** | Tamagoshi LDI — feat: itens saude na loja + verificação inventário + consumo ao concluir |
