...
|---|---|---|
| `SITE_VERSION` | **10.127.0** | Site — Phase3 layout revert + executarAtaque ref + logs diagnóstico |
...
| `ARENATESTBED_VERSION` | **1.1.0** | Arena Testbed — fix: layout revert + executarAtaque ref + logs diagnóstico |
