...
|---|---|---|
| `SITE_VERSION` | **10.158.9** | Investigação ampla: logs INV-A01 a INV-A12 + INV-B01 a INV-B08 |
...
| `ARENATESTBED_VERSION` | **6.3.4** | Investigação ampla: logs INV-A01 a INV-A12 + INV-B01 a INV-B08 |
