...
*Versão: 1.49*  |  `[SITE] versão carregada: 1.49`
...
| `/games/pesadelo` | PP | `src/pages/PesadeloParticular/PP.jsx` | 🔄 QA v1.5.2 | Pesadelo Particular — 20 casos, Supabase save, puzzles reais, combate, i18n — **EM FASE DE QUALIDADE** |
