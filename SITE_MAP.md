...
|---|---|---|
| `SITE_VERSION` | **10.158.5** | Extrair useCanvasLoop + CharModal + getDisplayName + subPhaseLabel do V2 |
...
| `ARENATESTBED_VERSION` | **6.3.0** | Extrair useCanvasLoop + CharModal + getDisplayName + subPhaseLabel do V2 |
