...
## Corpus Check
- 868 files · ~1,008,098 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4146 nodes · 7178 edges · 427 communities (287 shown, 140 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 49 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc2000de`
...
Cohesion: 0.11
Nodes (29): UnifiedNotification(), AchievementsContext, AchievementsProvider(), useAchievements(), AuthContext, AuthProvider(), useAuth(), DixContext (+21 more)
...
Cohesion: 0.10
Nodes (25): DesktopShellBar(), badgeCorClass(), ProdutoDigitalCard(), ShopSection(), useScrollReveal(), assertExternalPurchasesAllowed(), params, requestedClient (+17 more)
...
Cohesion: 0.05
Nodes (55): AchievementToast(), BackToGamesBtn(), LoginGate(), SearchModal(), TypewriterPhrase(), LanguageContext, useLanguage(), index (+47 more)
...
Cohesion: 0.06
Nodes (57): attack, fast, lucky, GanguesDescanso(), GanguesPapo(), addGanguesAp(), contarTerritoriosDominados(), defaultGanguesProgression() (+49 more)
...
Cohesion: 0.29
Nodes (13): avancarRodadaMultidao(), coin(), d3(), iniciarBrigaMultidao(), podePagarCusto(), fighterName(), GanguesCombat(), ONOMATOPEIAS (+5 more)
...
- **Why does `useLanguage()` connect `levelProgression.js` to `Community 0`, `Community 4`, `Community 8`, `Community 9`, `Community 10`, `sfx.js`, `CityOverworld.jsx`, `usePersonagens.js`, `useRadioNina.js`, `Community 20`, `Lobby.jsx`, `supabase.js`, `DeckBuilder.jsx`, `levelProgression.js`, `Community 29`, `useTopTrumpsRewards.js`, `PuzzleStealthGrid.jsx`, `initBattle`, `Community 33`, `TopTrumpsMP.jsx`, `MazeRafael.jsx`, `FichaGateRoute.jsx`, `Lobby.jsx`, `DixContext.jsx`, `TrialBanner.jsx`, `drawCombatBoard`, `PuzzleForça.jsx`, `Brincadeira.jsx`, `Quiz.jsx`, `Create`, `Community 49`, `Community 51`, `TopTrumpsCard.jsx`, `useSharedLobbyMachine.js`, `PuzzleForça.jsx`, `useGameStore.js`, `usePersonagens.js`, `BuildingInterior.jsx`, `drawCombatBoard`, `useFichas`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `useReader()` connect `usePersonagens.js` to `Community 0`, `TopTrumpsMP.jsx`, `MazeRafael.jsx`, `Community 4`, `levelProgression.js`, `drawCombatBoard`, `Community 3`, `PuzzleForça.jsx`, `Community 9`, `CityOverworld.jsx`, `Community 20`, `Lobby.jsx`, `useSharedLobbyMachine.js`, `DeckBuilder.jsx`, `levelProgression.js`, `useTopTrumpsRewards.js`, `PuzzleStealthGrid.jsx`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `SFX` connect `Community 7` to `MazeRafael.jsx`, `Community 4`, `levelProgression.js`, `drawCombatBoard`, `DeckBuilder.jsx`?**
