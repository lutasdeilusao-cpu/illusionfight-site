...
## Corpus Check
- 885 files · ~1,042,513 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4248 nodes · 7570 edges · 430 communities (296 shown, 134 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 56 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1de64b4f`
...
## Communities (430 total, 134 thin omitted)
...
Cohesion: 0.09
Nodes (28): DeferredSection(), DATA, GROUP_LABELS, GROUP_ORDER, usePersonagem(), usePersonagens(), useScrollReveal(), dataMap (+20 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (45): AchievementToast(), CharacterCard(), SearchModal(), TypewriterPhrase(), useLanguage(), index, usePersonagensAgrupados(), useTypewriter() (+37 more)
...
### Community 15 - "sfx.js"
Cohesion: 0.12
Nodes (27): ATTR_ORDER, bonusResumo(), DetalheItem(), GanguesLoja(), LinhaComparacao(), ATTR_ORDER, bonusResumo(), GanguesEquipPanel() (+19 more)
...
Cohesion: 0.07
Nodes (48): GuestNotice(), UnifiedNotification(), AchievementsContext, AchievementsProvider(), useAchievements(), AuthContext, AuthProvider(), useAuth() (+40 more)
...
Cohesion: 0.23
Nodes (9): GanguesDescanso(), GanguesPapo(), createGanguesEquipInstance(), GanguesEnemyPick(), pickEnemyTeam(), GanguesNaming(), limiteFichasPorTier(), podeCriarFicha() (+1 more)
...
Cohesion: 0.17
Nodes (17): CRIATURAS, calcularFase(), PERSONALIDADES, Alimentar(), Loja(), Ovo(), Partida(), TIPO_PARA_KEY (+9 more)
...
Cohesion: 0.16
Nodes (18): ReaderContext, ReaderProvider(), useReader(), Clues(), Combat(), ClueBook(), drawer, ManualDrawer() (+10 more)
...
Cohesion: 0.27
Nodes (8): BANCO, CONFIGS, prepararUnidades(), PuzzleAnagrama(), shuffleArray(), PuzzleSlidingTiles(), shuffleSolvable(), PuzzleWrapper()
...
Cohesion: 0.09
Nodes (29): AnalyticsTracker(), elementIdentity(), safeDestination(), SCROLL_MARKS, CookieBanner(), externalMap, Footer(), routeMap (+21 more)
...
### Community 414 - "PuzzleDecoder.jsx"
Cohesion: 0.32
Nodes (5): CONFIGS, gerarAlvo(), PuzzleDecoder(), GanguesParada(), PUZZLES

### Community 415 - "Calendario.jsx"
Cohesion: 0.39
...
### Community 425 - "PowerCard.jsx"
Cohesion: 0.47
Nodes (3): ELEM_ICON, PowerCard(), PowerDescription()

### Community 426 - "Jokempo.jsx"
Cohesion: 0.40
...
## Knowledge Gaps
- **1776 isolated node(s):** `1. Visão geral`, `2.1 Abertura (vinheta de carregamento)`, `3.1 Site e conteúdo`, `3.2 Plataforma e conta`, `3.3 Catálogo e jogos` (+1771 more)
...
- **Why does `useLanguage()` connect `Community 9` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `local`, `Community 8`, `Community 10`, `Phase0Start.jsx`, `endBattle`, `useSharedLobbyMachine.js`, `CityOverworld.jsx`, `Create`, `Community 20`, `Jokempo.jsx`, `UniversosHub.jsx`, `Universo.jsx`, `levelProgression.js`, `Community 29`, `PuzzleDecoder.jsx`, `PuzzleStealthGrid.jsx`, `initBattle`, `Community 33`, `TopTrumpsMP.jsx`, `Universo.jsx`, `ResultCard.jsx`, `PerfilColecao.jsx`, `getElem`, `useJackStore.js`, `GanguesLobby.jsx`, `PowerCard.jsx`, `react`, `Leaderboard.jsx`, `Calendario.jsx`, `combat.js`, `Community 49`, `Perfil.jsx`, `TopTrumpsCard.jsx`, `combat.js`, `PuzzleForça.jsx`, `getElem`, `useScrollReveal`, `Phase0Start.jsx`, `RestaurarSaude.jsx`, `useGameStore.js`, `Number`, `personalidades.js`, `Criatura.jsx`, `index.js`, `LDINotification.jsx`, `ganguesCharacters.js`, `useGanguesTurnMachine.js`, `PuzzleStealthGrid.jsx`, `audioManager.js`?**
  _High betweenness centrality (0.121) - this node is a cross-community bridge._
- **Why does `useReader()` connect `PerfilColecao.jsx` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 9`, `combat.js`, `useSharedLobbyMachine.js`, `CityOverworld.jsx`, `Community 20`, `TopTrumpsCard.jsx`, `Jokempo.jsx`, `audioManager.js`, `Criatura.jsx`, `Community 29`, `getElem`, `PuzzleStealthGrid.jsx`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `CityOverworld.jsx` to `Community 1`, `Community 8`, `Community 9`, `endBattle`, `useSharedLobbyMachine.js`, `Community 20`, `levelProgression.js`, `Jokempo.jsx`, `PuzzleStealthGrid.jsx`, `Calendario.jsx`, `Community 33`, `TopTrumpsMP.jsx`, `PerfilColecao.jsx`, `ResultCard.jsx`, `useJackStore.js`, `GanguesLobby.jsx`, `Leaderboard.jsx`, `combat.js`, `TopTrumpsCard.jsx`, `getElem`, `LDINotification.jsx`?**
