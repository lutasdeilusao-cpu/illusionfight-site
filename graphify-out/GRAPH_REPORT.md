# Graph Report - SiteLDI  (2026-09-07)

## Corpus Check
- 884 files · ~1,039,457 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4231 nodes · 7588 edges · 430 communities (294 shown, 136 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 56 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c341eda6`
...
- Quiz.jsx
- CHAPTER 9: "Começando o treinamento?"
- CHAPTER 11: "Bebendo com os amigos"
- CHAPTER 14: "A mudança necessária!"
...
- CHARACTER: Helena
- CHARACTER: Jack
- CHARACTER: Kim (Joaquim Leal Reis)
- CHARACTER: Lisa
- CHARACTER: Nina
- CHARACTER: Pajé Yawanari
- CHARACTER: Shuntaro Chirasu
- CHAPTER 3: "Que tipo de briga é essa?"
- CHAPTER 4: "O Pajé mais Cringe que existe?"
- CHAPTER 5: "Não me julgue"
- CHAPTER 6: "Não me julgue"
- CHAPTER 7: "Conhecendo Dona Helena!"
- CHAPTER 13: "Kim mostra sua lábia com o broto!"
- CapabilityRemote
...
1. `useLanguage()` - 390 edges
2. `useAuth()` - 117 edges
3. `useReader()` - 59 edges
4. `SFX` - 59 edges
5. `logEntry()` - 43 edges
6. `AudioManager` - 42 edges
7. `useKpI18n()` - 39 edges
8. `Phase6CombatV2()` - 34 edges
9. `🟣 Elite (32 cartas)` - 33 edges
10. `useJackStore` - 32 edges
...
- `Navbar()` --indirect_call--> `path()`  [INFERRED]
  src/components/Navbar.jsx → src/pages/games/Gangues/data/ganguesSpecials.js
...
- `Universo()` --calls--> `useLanguage()`  [EXTRACTED]
  src/pages/content/Universo.jsx → src/context/LanguageContext.jsx

## Import Cycles
- None detected.

## Communities (430 total, 136 thin omitted)
...
Cohesion: 0.08
Nodes (32): CharacterCard(), DeferredSection(), ShopSection(), DATA, GROUP_LABELS, GROUP_ORDER, usePersonagem(), usePersonagens() (+24 more)
...
Cohesion: 0.14
Nodes (18): LanguageContext, deepMerge(), getNested(), LanguageProvider(), areaDaRota(), AREAS, carregarArea(), carregarCore() (+10 more)
...
### Community 15 - "sfx.js"
Cohesion: 0.19
Nodes (15): GanguesLoja(), ATTR_ORDER, bonusResumo(), GanguesEquipPanel(), createGanguesEquipInstance(), emptyGanguesEquipment(), GANGUES_EQUIP, GANGUES_EQUIP_LISTA (+7 more)
...
Cohesion: 0.18
Nodes (13): FichaGateRoute(), getHoje(), isDesbloqueadoHoje(), ModalConfirmacaoFicha(), ModalSemFichas(), ABAS, ADMIN_EMAILS, BADGE_CORES (+5 more)
...
Cohesion: 0.11
Nodes (18): 10. NeoGuide — diálogo e tutoriais guiados, 11. i18n, 12. Persistência, 13. Estrutura de arquivos, 14. Pontos em aberto / ideias pra continuar, 1. Visão geral, 2. Criação de personagem, 3. Bônus de caminho (ativos em todo ataque/defesa) (+10 more)
...
Cohesion: 0.18
Nodes (11): attack, fast, lucky, getGanguesAttributesWithEquip(), GANGUES_PATHS, getGanguesResources(), normalizeGanguesLoadout(), resolveGanguesInitiative() (+3 more)
...
Cohesion: 0.06
Nodes (45): AchievementToast(), BackToGamesBtn(), GuestNotice(), SearchModal(), useLanguage(), index, ConfirmEndTurn(), Derrota() (+37 more)

### Community 30 - "useTopTrumpsRewards.js"
Cohesion: 0.07
Nodes (23): CENA_PISTA, CENAS_POR_ID, temCena(), cenaIntroJaVista(), COLLIDERS, ENTRY_ZONES, estadoPoi(), GanguesCena() (+15 more)
...
Cohesion: 0.18
Nodes (13): atualizarStats(), carregarStats(), carregarTentativas(), consumirTentativa(), getPeriod(), marcarCartaGanha(), registrarPartida(), _registrarPontuacao() (+5 more)

### Community 33 - "Community 33"
Cohesion: 0.10
Nodes (28): App(), AchievementsProvider(), AuthProvider(), DixContext, DixProvider(), useDix(), EventosProvider(), ADMIN_EMAILS (+20 more)

### Community 34 - "TopTrumpsMP.jsx"
Cohesion: 0.10
Nodes (22): DesktopShellBar(), badgeCorClass(), ProdutoDigitalCard(), TrialBanner(), ADMIN_EMAILS, assertExternalPurchasesAllowed(), params, requestedClient (+14 more)
...
### Community 44 - "useRafaelI18n"
Cohesion: 0.13
Nodes (14): 1. O problema hoje, 2. O que a gente quer, 3. O que já temos no projeto pra reaproveitar, 4.1 Os 5 tipos de POI (constrói uma vez cada), 4.2 Como navegar sem d-pad, 4.3 Economia leve (proposta — decisão aberta), 4. O modelo proposto: o bairro vira uma CENA, 5. A Pista — a primeira interação completa (protótipo) (+6 more)

### Community 45 - "Home.jsx"
Cohesion: 0.12
Nodes (16): 10. Onde o texto do jogo mora (i18n), 11. Persistência — confirmando o que você perguntou, 12. Estrutura de arquivos (visão rápida), 13. Histórico recente (de onde viemos), 14. Pontos em aberto (o que falta / vale revisar), 1. O que é o jogo, em uma frase, 2. Criação de personagem — o que já existe, 3. Os 3 caminhos e o bônus passivo de cada um (+8 more)
...
Cohesion: 0.06
Nodes (35): GanguesDescanso(), GanguesPapo(), GangDialog(), GanguesEnemyPick(), pickEnemyTeam(), GanguesNaming(), useGanguesStore, BulletHellRafael() (+27 more)
...
Cohesion: 0.12
Nodes (17): gh-pages, devDependencies, gh-pages, pg, @playwright/test, @tauri-apps/cli, @types/react, @types/react-dom (+9 more)
...
### Community 62 - "getElem"
Cohesion: 0.18
Nodes (18): CRIATURAS, calcularFase(), Alimentar(), Banhar(), Criatura(), Loja(), Partida(), TIPO_PARA_KEY (+10 more)

### Community 63 - "Community 63"
Cohesion: 0.11
Nodes (17): Battle Formats, Combat Modes, Death & Recovery, Elemental Interactions, Elemental System, Energy System, Entry & Exit Rules, Free Hands Mode (+9 more)

### Community 64 - "Community 64"
Cohesion: 0.11
Nodes (17): CAP 10 — "O preço do sucesso", CAP 11 — "Bebendo com os amigos", CAP 12 — "Cuidado a gatinha tem garras", CAP 13 — "Kim mostra sua lábia com o broto!", CAP 14 — "A mudança necessária!", CAP 1 — "Quem é esse cara?", CAP 2 — "A garota nova!!!", CAP 3 — "Que tipo de briga é essa?" (+9 more)
...
Cohesion: 0.12
Nodes (16): 1. AS 6 CLASSES BASE, 2. OS 20 PERSONAGENS, 3. ÁRVORE COMPLETA DE EVOLUÇÃO (42 NÓS), 4. FORA DO POOL (Personagens 11-20), 5. CONTAGEM FINAL CONFIRMADA, 🌳 IGNIS (Sábio), 🌳 KARUAK (Cavaleiro), 🔴 KARUAK — Cavaleiro (Espadachim) (+8 more)
...
Cohesion: 0.29
Nodes (7): ChoiceList(), container, itemAnim, detectarPrefixo(), isFala(), PERSONAGEM_STYLE, Typewriter()
...
Cohesion: 0.12
Nodes (16): A. Conto do Jack  ✅ COMPLETO — 9 caps (id 05, v10.198.90..100), Ajustes nos contos existentes (pendentes de decisão), (arquivado) Ideia original do conto do Jack  ⭐ prioridade, B. Conto da Helena  ⭐ o soco pesado, C. Conto do Osvaldo, D. "A Noite dos Trinta Homens" (POV de fora — Brock, ou um dos que apanhou), E. O avô do Kim (mitologia), Estado atual do selo (o que já existe) (+8 more)

### Community 81 - "Community 81"
Cohesion: 0.20
Nodes (10): scripts, build, deploy, desktop:build, desktop:dev, desktop:steam, dev, migration (+2 more)
...
Cohesion: 0.17
Nodes (11): core:window:allow-close, core:window:allow-destroy, https://illusionfight.com, main, description, identifier, permissions, remote (+3 more)

### Community 89 - "Community 89"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 90 - "combat.js"
Cohesion: 0.29
...
Cohesion: 0.10
Nodes (23): breadcrumbFor(), canonicalUrl(), capitulos, contos, DIST_DIR, episodios, escapeHtml(), extraGameRoutes (+15 more)
...
Cohesion: 0.15
Nodes (12): 1. Orquestrador, 2. Componentes de Fase (phases/), 3. Componentes de UI Reutilizáveis/Auxiliares, 4. engine/ — Lógica pura, 5. data/ — Catálogos e armazenamento, 6. Documentação, 7. ⚪ engine/ai/index.js — Órfão com imports quebrados, ArenaTestbed — Mapa Completo de Arquivos (+4 more)
...
Cohesion: 0.15
Nodes (12): BEAT 1.10 — The Pink-Haired Variable, BEAT 1.11 — The Aftermath Settles, BEAT 1.1 — The Nightmare, BEAT 1.2 — The Waking World, BEAT 1.3 — The Living Room Battlefield, BEAT 1.4 — The Morning War, BEAT 1.5 — The Friend at the Door, BEAT 1.6 — The Candy Route (+4 more)

### Community 103 - "Community 103"
Cohesion: 0.50
Nodes (3): ALLOWED_PRICE_IDS, stripe, supabase

### Community 108 - "RestaurarSaude.jsx"
Cohesion: 0.13
Nodes (14): anyOf, definitions, Number, PermissionEntry, Target, description, anyOf, description (+6 more)

### Community 110 - "SearchModal.jsx"
Cohesion: 0.17
Nodes (12): $ref, array, null, description, items, type, uniqueItems, description (+4 more)

### Community 111 - "MazeRafael.jsx"
Cohesion: 0.17
...
Cohesion: 0.18
Nodes (10): BEAT 9.1 — The Private Room, BEAT 9.2 — The Recovery, BEAT 9.3 — Avatar Reveals, BEAT 9.4 — Two on One, BEAT 9.5 — The Xakixi Manifest, BEAT 9.6 — Yawanari's Warning, BEAT 9.7 — Nina Falls, BEAT 9.8 — Vitória Finals (+2 more)

### Community 164 - "CHAPTER 11: "Bebendo com os amigos""
Cohesion: 0.18
Nodes (10): BEAT 11.1 — The Avatar Anomaly, BEAT 11.2 — The Rules, BEAT 11.3 — The Shadow, BEAT 11.4 — The Ambush, BEAT 11.5 — The Retreat, BEAT 11.6 — The Splitting, BEAT 11.7 — Kim vs. Roxy, BEAT 11.8 — Nina vs. The Predators (+2 more)

### Community 165 - "CHAPTER 14: "A mudança necessária!""
Cohesion: 0.18
Nodes (10): BEAT 14.1 — The Challenger's Entrance, BEAT 14.2 — Kim's New Look, BEAT 14.3 — Multiple Water Balls, BEAT 14.4 — The Audience Reacts, BEAT 14.5 — The Break, BEAT 14.6 — Adaptation, BEAT 14.7 — The Uppercut, BEAT 14.8 — Rei Xamã (+2 more)

### Community 166 - "BONUS: "Sagas Primordiais I: O Início!""
Cohesion: 0.18
Nodes (10): BEAT B.1 — The Golden Age, BEAT B.2 — The Omens, BEAT B.3 — Powa's Ambition, BEAT B.4 — The Betrayal, BEAT B.5 — The Sacrifice, BEAT B.6 — The Erasure, BEAT B.7 — The Invasion, BEAT B.8 — The Watcher's Descent (+2 more)

### Community 167 - "Uso: RAG reference. Cada entrada é um chunk independente."
Cohesion: 0.18
Nodes (10): BLOCO 1 — SISTEMAS LDI (Monetização e Acesso), BLOCO 2 — ENTIDADES E ORGANIZAÇÕES, BLOCO 3 — MECÂNICAS DE COMBATE, BLOCO 4 — SISTEMA ELEMENTAL, BLOCO 5 — ARMAS NOMEADAS, BLOCO 6 — PODERES E TÉCNICAS ESPECIAIS, BLOCO 7 — MUNDO DE BRAVARA (Tecnologia e Serviços), BLOCO 8 — XAKAXI (Termos Históricos e Culturais) (+2 more)

### Community 168 - "📋 Workflow Obrigatório (nesta ordem)"
Cohesion: 0.18
...
Cohesion: 0.20
Nodes (9): Abilities / Skills, Background Summary, CHARACTER: David Kronos, Current Situation, Key Relationships, Narrative Arc, Personality Core, Physical Description (+1 more)

### Community 171 - "CHARACTER: Helena"
Cohesion: 0.20
Nodes (9): Abilities / Skills, Background Summary, CHARACTER: Helena, Current Situation, Key Relationships, Narrative Arc, Personality Core, Physical Description (+1 more)

### Community 172 - "CHARACTER: Jack"
Cohesion: 0.20
Nodes (9): Abilities / Skills, Background Summary, CHARACTER: Jack, Current Situation, Key Relationships, Narrative Arc, Personality Core, Physical Description (+1 more)

### Community 173 - "CHARACTER: Kim (Joaquim Leal Reis)"
Cohesion: 0.20
Nodes (9): Abilities / Skills, Background Summary, CHARACTER: Kim (Joaquim Leal Reis), Current Situation, Key Relationships, Narrative Arc, Personality Core, Physical Description (+1 more)

### Community 174 - "CHARACTER: Lisa"
Cohesion: 0.20
Nodes (9): Abilities / Skills, Background Summary, CHARACTER: Lisa, Current Situation, Key Relationships, Narrative Arc, Personality Core, Physical Description (+1 more)

### Community 175 - "CHARACTER: Nina"
Cohesion: 0.20
Nodes (9): Abilities / Skills, Background Summary, CHARACTER: Nina, Current Situation, Key Relationships, Narrative Arc, Personality Core, Physical Description (+1 more)

### Community 176 - "CHARACTER: Pajé Yawanari"
Cohesion: 0.20
Nodes (9): Abilities / Skills, Background Summary, CHARACTER: Pajé Yawanari, Current Situation, Key Relationships, Narrative Arc, Personality Core, Physical Description (+1 more)

### Community 177 - "CHARACTER: Shuntaro Chirasu"
Cohesion: 0.20
Nodes (9): Abilities / Skills, Background Summary, CHARACTER: Shuntaro Chirasu, Current Situation, Key Relationships, Narrative Arc, Personality Core, Physical Description (+1 more)

### Community 178 - "CHAPTER 3: "Que tipo de briga é essa?""
Cohesion: 0.20
Nodes (9): BEAT 3.1 — The Setup, BEAT 3.2 — The Birth of Briguento, BEAT 3.3 — The Arena, BEAT 3.4 — The Torture Begins, BEAT 3.5 — The Checklist, BEAT 3.6 — Refusal, BEAT 3.7 — The Helpless Witness, BEAT 3.8 — The Threshold (+1 more)

### Community 179 - "CHAPTER 4: "O Pajé mais Cringe que existe?""
Cohesion: 0.20
Nodes (9): BEAT 4.1 — The Spirit Realm, BEAT 4.2 — The Offer, BEAT 4.3 — The Transformation, BEAT 4.4 — The Reckoning, BEAT 4.5 — The Shockwave, BEAT 4.6 — Yohualticit Alarms, BEAT 4.7 — The Aftermath, BEAT 4.8 — The New Reality (+1 more)

### Community 180 - "CHAPTER 5: "Não me julgue""
Cohesion: 0.20
Nodes (9): BEAT 5.1 — Post-Fight Calm, BEAT 5.2 — The Interruption, BEAT 5.3 — The Challenge, BEAT 5.4 — The Fight: Phase One, BEAT 5.5 — The Fight: Adaptation, BEAT 5.6 — The Distraction, BEAT 5.7 — Respect Earned, BEAT 5.8 — The Project (+1 more)

### Community 181 - "CHAPTER 6: "Não me julgue""
Cohesion: 0.20
Nodes (9): BEAT 6.1 — The Beating, BEAT 6.2 — The Intervention, BEAT 6.3 — The Liquor Run, BEAT 6.4 — The Classroom, BEAT 6.5 — LDI 101, BEAT 6.6 — The Anonymity Question, BEAT 6.7 — Drunken Confessions, BEAT 6.8 — Walking Home (+1 more)

### Community 182 - "CHAPTER 7: "Conhecendo Dona Helena!""
Cohesion: 0.20
Nodes (9): BEAT 7.1 — The Same Old Scene, BEAT 7.2 — The Demand, BEAT 7.3 — The Storm, BEAT 7.4 — The Calm, BEAT 7.5 — The Revelation, BEAT 7.6 — The Embrace, BEAT 7.7 — Rebuilding, BEAT 7.8 — A New Night (+1 more)

### Community 183 - "CHAPTER 13: "Kim mostra sua lábia com o broto!""
Cohesion: 0.20
Nodes (9): BEAT 13.1 — The Awkward Exit, BEAT 13.2 — Dinner and a Show, BEAT 13.3 — The Club, BEAT 13.4 — The Calm Bouncer, BEAT 13.5 — The Weekend, BEAT 13.6 — The Visitor, BEAT 13.7 — The Warning, BEAT 13.8 — The Anticipation (+1 more)

### Community 184 - "CapabilityRemote"
Cohesion: 0.22
Nodes (9): description, properties, required, type, CapabilityRemote, urls, urls, description (+1 more)

### Community 185 - "Lutas de Ilusão (LDI) — Monetization"
Cohesion: 0.22
Nodes (8): LT Currency (Moedas), Lutas de Ilusão (LDI) — Monetization, SAL — Sistema de Acesso Limitado (Limited Access System), SDA — Sistema de Apostas (Betting System), SDD — Sistema de Doações (Donation System), SDP — Sistema de Parcerias (Partnership System), STE — Sistema de Treinamento Exclusivo (Exclusive Training System), SVN — Sistema de Venda de NFTs (NFT Sale System)

### Community 186 - "Relationship Arcs — Lutas de Ilusão"
Cohesion: 0.22
Nodes (8): Jack ↔ Nina, Kim ↔ David Kronos, Kim ↔ Helena, Kim ↔ Jack, Kim ↔ Lisa, Kim ↔ Nina, Kim ↔ Pajé Yawanari, Relationship Arcs — Lutas de Ilusão

### Community 187 - "CHAPTER 10: "O preço do sucesso""
Cohesion: 0.22
...
Cohesion: 0.25
Nodes (7): Kim Primordial Transformation Details, Manifestation in Kim, Origin, Primordial Power (Sangue Primordial), What It Is, Why David Kronos Wants It, Yohualticit Alarms

### Community 191 - "CHAPTER 8: "Meu bebê? Que história é essa?""
Cohesion: 0.25
Nodes (7): BEAT 8.1 — The Unfamiliar Morning, BEAT 8.2 — The Story Shared, BEAT 8.3 — The Director's Warning, BEAT 8.4 — The Gift, BEAT 8.5 — The Viral Truth, BEAT 8.6 — The Decision, CHAPTER 8: "Meu bebê? Que história é essa?"

### Community 192 - "CHAPTER 12: "Cuidado a gatinha tem garras""
Cohesion: 0.25
Nodes (7): BEAT 12.1 — Nina's Cunning, BEAT 12.2 — Jack's Breaking Point, BEAT 12.3 — Kim's Endurance, BEAT 12.4 — Reunion, BEAT 12.5 — The Job Offer, BEAT 12.6 — Awkward Silence, CHAPTER 12: "Cuidado a gatinha tem garras"

### Community 193 - "ISA UNIVERSE — WRITING STYLE GUIDE"
Cohesion: 0.25
...
Cohesion: 0.29
Nodes (6): #10 — David Kronos — Primordial, #74 — Vale das Cinzas — Destruição, #75 — Kim Primordial — Forma Liberada, #76 — Alan — O Campeão, 🔴 Primordial (4 cartas), 🃏 Top Trumps — LDI: Todas as Cartas

### Community 197 - "🟡 Lendário (6 cartas)"
Cohesion: 0.29
Nodes (7): #11 — Xakaxi — O Grande Cacique, #12 — Nara — A Guerreira, #13 — Powa — O Corrompido, #31 — Kawa — O Guerreiro Traído, #32 — Tawira — O Herdeiro, #33 — Iara — A Curandeira, 🟡 Lendário (6 cartas)

### Community 198 - "Bravara"
Cohesion: 0.29
Nodes (6): Bravara, Culture, Geography, History, Society, Technology in 2030

### Community 199 - "ISA UNIVERSE — COMPLETE TIMELINE"
Cohesion: 0.29
...
Cohesion: 0.40
Nodes (4): Deploy via CLI (alternativa), Setup no dashboard (uma vez), songs-r2 Worker, Teste
...
Cohesion: 0.40
Nodes (3): ATTRS, GanguesFichaCard(), PATH_MARKS

### Community 291 - "PerfilColecao.jsx"
Cohesion: 0.12
Nodes (23): ReaderContext, useReader(), CodigoPerdido(), DIF_CFG, KEYBOARD_ROWS, pick(), PuzzleCodigoPerdido(), Clues() (+15 more)

### Community 292 - "Value"
Cohesion: 0.67
Nodes (3): Value, anyOf, description

### Community 301 - "combat.js"
Cohesion: 0.13
Nodes (27): Farol(), pesoIndex(), PESOS, contoLiberado(), estaDisponivel(), useAuth(), readerMdComponents, ContoCapitulo() (+19 more)

### Community 304 - "index.js"
Cohesion: 0.24
Nodes (14): GANGUES_ITENS, GANGUES_ITENS_LISTA, getGanguesItem(), computarContribuicoes(), fighterName(), GanguesCombat(), marcarMultidaoBlinkVisto(), multidaoBlinkJaVisto() (+6 more)
...
### Community 309 - "paridade-exata.mjs"
Cohesion: 0.33
Nodes (8): calcularPontosTime(), caminhoDoInimigo(), distribuirPontos(), escalarInimigo(), GANGUES_CHEFE_EQUIPE, GANGUES_DIFICULDADE_RATIO, GANGUES_TERRITORIO_ENCONTRO, gerarBandoInimigo()

### Community 313 - "TypewriterPhrase.jsx"
Cohesion: 0.43
...
### Community 352 - "LDINotification.jsx"
Cohesion: 0.11
Nodes (23): AnalyticsTracker(), elementIdentity(), safeDestination(), SCROLL_MARKS, CookieBanner(), externalMap, Footer(), routeMap (+15 more)

### Community 372 - "BuildingInterior.jsx"
Cohesion: 0.60
Nodes (5): avancarRodadaMultidao(), coin(), d3(), iniciarBrigaMultidao(), podePagarCusto()

### Community 373 - "ganguesCharacters.js"
Cohesion: 0.27
Nodes (16): createGanguesTemplateSheet(), GANGUES_CHARACTER_BY_ID, GANGUES_CHARACTER_CATALOG, GANGUES_EVENT_CHARACTER_IDS, GANGUES_FIRST_CAMPAIGN_CHARACTER_IDS, GANGUES_INITIAL_CHARACTER_IDS, GANGUES_SECOND_CLEAR_CHARACTER_IDS, getGanguesAvailableCharacterIds() (+8 more)

### Community 374 - "useGanguesTurnMachine.js"
Cohesion: 0.17
...
Cohesion: 0.18
Nodes (15): addGanguesAp(), contarTerritoriosDominados(), GANGUES_ATTRIBUTE_XP_COSTS, GANGUES_RESOURCE_RATES, GANGUES_ROSTER_LIMITS, GANGUES_SAVE_SLOT_LIMITS, GANGUES_SPECIAL_COSTS, ganguesApCostForLevel() (+7 more)

### Community 376 - "PuzzleStealthGrid.jsx"
Cohesion: 0.08
Nodes (40): BANCO, CONFIGS, prepararUnidades(), PuzzleAnagrama(), shuffleArray(), CONFIGS, gerarAlvo(), PuzzleDecoder() (+32 more)

### Community 377 - "audioManager.js"
Cohesion: 0.12
...
### Community 379 - "paridade-exata.mjs"
Cohesion: 0.20
Nodes (14): salvarCartasDeck(), substituirDeck(), ACCESS_RANK, canAcquireTopTrumpsCard(), CARD_IDS_BY_TIER, CARD_RANK, filterTopTrumpsCardPool(), filterTopTrumpsInitialAccountPool() (+6 more)

### Community 396 - "ganguesSpecials.js"
Cohesion: 0.25
Nodes (13): resolveAttackerBonus(), resolveDefenderBonus(), resolveGanguesAction(), applyGanguesAttackerEffect(), applyGanguesDefenderEffect(), buildGanguesEffectsList(), E(), GANGUES_SPECIAL_EFFECTS (+5 more)

### Community 398 - "ArenaTaticsRoute.jsx"
Cohesion: 0.31
Nodes (9): ACESSORIOS, ARMADURAS, ARMES, calcularBonus(), getAllEquipamentos(), getEquipamento(), ELEM_COR, EMOJI (+1 more)

### Community 400 - "useSharedLobbyMachine.js"
Cohesion: 0.11
...
### Community 402 - "Create"
Cohesion: 0.15
Nodes (19): UnifiedNotification(), AchievementsContext, useAchievements(), AuthContext, EventosContext, METAS_PROGRESSO, useEventos(), useReadingCompletionGate() (+11 more)

### Community 403 - "index.js"
Cohesion: 0.23
...
### Community 411 - "GanguesVictory.jsx"
Cohesion: 0.83
Nodes (3): combatantName(), eventosDoLevelUp(), GanguesVictory()

### Community 412 - "ganguesTerritorios.js"
Cohesion: 0.27
Nodes (10): estadoNo(), estadoTerritorio(), GANGUES_DIFICULDADES, GANGUES_NO_FINAL, GANGUES_TERRITORIO_POR_ID, GANGUES_TERRITORIOS, precisaVoltarNoInformante(), progressoTerritorio() (+2 more)

### Community 413 - "Jokempo.jsx"
Cohesion: 0.40
Nodes (3): CHOICES, EMOJI, Jokempo()

### Community 414 - "LDINotification.jsx"
Cohesion: 0.29
Nodes (8): calcDamage(), calcFA(), calcFD(), calcInitiative(), deathTest(), rollD6(), rollWithDelay(), testAttribute()

### Community 415 - "drawCombatBoard"
Cohesion: 0.30
...
### Community 418 - "Phase2Customize.jsx"
Cohesion: 0.31
Nodes (9): defaultGanguesProgression(), carregarProgressoHistoria(), criarSave(), excluirSave(), listarSaves(), salvarProgressoHistoria(), defaultSheet(), limiteFichasPorTier() (+1 more)

### Community 419 - "Phase1SheetBuilder.jsx"
Cohesion: 0.24
Nodes (4): calcAtkWithTerrain(), calcDefWithTerrain(), eq(), getTerrainMods()

### Community 420 - "ResultCard.jsx"
Cohesion: 0.36
...
### Community 425 - "GanguesActionOrb.jsx"
Cohesion: 0.70
Nodes (4): ANCHORS, GanguesActionOrb(), posSalva(), salvarPos()

### Community 426 - "SearchModal.jsx"
Cohesion: 0.23
Nodes (8): usePresence(), GameOverScreen(), ONOMATOPEIAS, useGameEffects(), useTopTrumpsRewards(), useTopTrumpsSP(), TopTrumpsSP(), attrNomeKey()

### Community 427 - "Leaderboard.jsx"
Cohesion: 0.30
Nodes (12): getNomePais(), PAISES, _carregarPosicao(), carregarPosicaoUsuario(), carregarPosicaoUsuarioArena(), carregarPosicaoUsuarioTama(), carregarRanking, carregarRankingArena() (+4 more)

### Community 428 - "ResultScreen.jsx"
Cohesion: 0.31
Nodes (6): useSwipe(), BurstParticles(), ResultScreen(), BANNERS, HeroSlideshow(), SLIDE_KEYS

### Community 429 - "ResultCard.jsx"
Cohesion: 0.57
Nodes (4): FRASES, getFrase(), PALETTES, ResultCard()

## Knowledge Gaps
- **1769 isolated node(s):** `1. Visão geral`, `2.1 Abertura (vinheta de carregamento)`, `3.1 Site e conteúdo`, `3.2 Plataforma e conta`, `3.3 Catálogo e jogos` (+1764 more)
...
- **Why does `useLanguage()` connect `Community 29` to `Community 0`, `Community 1`, `local`, `Community 8`, `Community 9`, `Community 10`, `endBattle`, `useSharedLobbyMachine.js`, `CityOverworld.jsx`, `Create`, `Community 20`, `Lobby.jsx`, `UniversosHub.jsx`, `Universo.jsx`, `levelProgression.js`, `PuzzleStealthGrid.jsx`, `drawCombatBoard`, `Community 33`, `TopTrumpsMP.jsx`, `PerfilColecao.jsx`, `ResultCard.jsx`, `TypewriterPhrase.jsx`, `getElem`, `useJackStore.js`, `EventosContext.jsx`, `PuzzleForça.jsx`, `react`, `SearchModal.jsx`, `PowerCard.jsx`, `combat.js`, `ResultCard.jsx`, `Leaderboard.jsx`, `ResultScreen.jsx`, `Community 49`, `Perfil.jsx`, `TopTrumpsCard.jsx`, `TypewriterPhrase.jsx`, `PuzzleForça.jsx`, `getElem`, `useScrollReveal`, `Phase0Start.jsx`, `RestaurarSaude.jsx`, `useGameStore.js`, `Number`, `Universo.jsx`, `combat.js`, `Criatura.jsx`, `LDINotification.jsx`, `useGanguesTurnMachine.js`, `PuzzleStealthGrid.jsx`, `audioManager.js`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `useReader()` connect `PerfilColecao.jsx` to `Community 0`, `Community 1`, `Community 3`, `EventosContext.jsx`, `SearchModal.jsx`, `combat.js`, `useSharedLobbyMachine.js`, `Create`, `Community 20`, `TopTrumpsCard.jsx`, `PuzzleStealthGrid.jsx`, `audioManager.js`, `Community 29`, `getElem`, `drawCombatBoard`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `AudioManager` connect `Community 5` to `audioManager.js`, `Community 33`?**
