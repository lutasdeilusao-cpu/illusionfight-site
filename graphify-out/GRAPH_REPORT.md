...
## Corpus Check
- 673 files · ~791,843 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3295 nodes · 6512 edges · 274 communities (240 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 52 edges (avg confidence: 0.68)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5ee60b74`
...
Cohesion: 0.11
Nodes (29): BookChaptersRow(), capaMap, formatarData(), LatestEpisodes(), thumbMap, LoginGate(), TrialBanner(), ADMIN_EMAILS (+21 more)
...
Cohesion: 0.15
Nodes (28): ATTRIBUTES, GanguesProgressionPanel(), SPECIAL_ICON, addGanguesAp(), GANGUES_ATTRIBUTE_XP_COSTS, GANGUES_PARTY_SIZE_THRESHOLDS, GANGUES_RESOURCE_RATES, GANGUES_ROSTER_LIMITS (+20 more)
...
Cohesion: 0.06
Nodes (46): AchievementToast(), CharacterCard(), TypewriterPhrase(), useLanguage(), DATA, GROUP_LABELS, GROUP_ORDER, usePersonagem() (+38 more)
...
Cohesion: 0.12
Nodes (34): getPoderesDisponiveis(), getPoderesPorId(), PODERES_BASE, temPoderDisponivel(), decidirAcaoIA(), getPersonalidadePorId(), PERSONALIDADES_IA, acaoPersistente() (+26 more)
...
Cohesion: 0.16
Nodes (14): AchievementsContext, AchievementsProvider(), AuthContext, AuthProvider(), DixContext, DixProvider(), EventosContext, EventosProvider() (+6 more)
...
Cohesion: 0.08
Nodes (39): BackToGamesBtn(), GuestNotice(), DramaticDice(), NeoGuideDialog(), NeoGuideTip(), defaultGanguesProgression(), getGanguesPartySizeLimit(), getGanguesRosterLimit() (+31 more)
...
Cohesion: 0.16
Nodes (25): PERSONALIDADES, acaoFujona(), avancarUmaCasa(), celulaMaisDistante(), inimigoMaisFracoEmAlcance(), inimigoMaisProximo(), acaoSanguinaria(), calcularPassos() (+17 more)
...
Cohesion: 0.22
Nodes (8): usePresence(), GameOverScreen(), GameScreen(), ONOMATOPEIAS, useGameEffects(), useTopTrumpsSP(), TopTrumpsSP(), attrNomeKey()
...
- **Why does `useLanguage()` connect `initBattle` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `ArenaTaticsRoute.jsx`, `Community 9`, `Vila.jsx`, `ResultCard.jsx`, `Community 12`, `Community 10`, `endBattle`, `sfx.js`, `regrasFicha.js`, `CityOverworld.jsx`, `Community 19`, `Community 20`, `Lobby.jsx`, `Create`, `Batalha.jsx`, `Community 29`, `BLOCO B — LINKEDIN PESSOAL ISAIAS`, `PuzzleStealthGrid.jsx`, `Community 33`, `TopTrumpsMP.jsx`, `useJackStore.js`, `ResultScreen.jsx`, `PuzzleStealthGrid.jsx`, `Community 49`, `Perfil.jsx`, `PP.jsx`, `BLOCO G — NUNTIUS GAMES — POSICIONAMENTO INSTITUCIONAL`, `useAuth`, `useTopTrumpsRewards.js`, `GanguesRoute.jsx`, `Community 62`, `Brincadeira.jsx`, `useScrollReveal`, `RestaurarSaude.jsx`, `PerfilColecao.jsx`, `Quiz.jsx`, `AnalyticsTracker.jsx`, `MazeRafael.jsx`, `Phase0Start.jsx`, `particles.js`, `PuzzleForça.jsx`, `classTree.js`, `DeckBuilder.jsx`, `ShopSection.jsx`, `GanguesLobby.jsx`, `GanguesCombat.jsx`, `ganguesSpecialEffects.js`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `useReader()` connect `Quiz.jsx` to `Community 0`, `Community 1`, `TopTrumpsMP.jsx`, `initBattle`, `Community 3`, `RestaurarSaude.jsx`, `endBattle`, `PuzzleStealthGrid.jsx`, `GanguesLobby.jsx`, `Community 20`, `Lobby.jsx`, `Phase0Start.jsx`, `PuzzleForça.jsx`, `useTopTrumpsRewards.js`, `GanguesRoute.jsx`, `ganguesSpecialEffects.js`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `endBattle` to `Community 1`, `Community 2`, `Community 9`, `sfx.js`, `Community 20`, `Lobby.jsx`, `Create`, `Community 29`, `BLOCO B — LINKEDIN PESSOAL ISAIAS`, `initBattle`, `TopTrumpsMP.jsx`, `PuzzleStealthGrid.jsx`, `PP.jsx`, `useAuth`, `GanguesRoute.jsx`, `Brincadeira.jsx`, `RestaurarSaude.jsx`, `Quiz.jsx`, `AnalyticsTracker.jsx`, `particles.js`, `ShopSection.jsx`, `GanguesLobby.jsx`?**
