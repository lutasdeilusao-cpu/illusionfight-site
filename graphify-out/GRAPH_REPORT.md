...
## Corpus Check
- 895 files · ~1,150,944 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4411 nodes · 7740 edges · 436 communities (299 shown, 137 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 57 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d81f9329`
...
## Communities (436 total, 137 thin omitted)
...
Cohesion: 0.16
Nodes (16): LOCALES, Navbar(), SITE_CONFIG, LanguageContext, deepMerge(), getNested(), LanguageProvider(), useScrollPosition() (+8 more)
...
Cohesion: 0.17
Nodes (17): ReaderContext, useReader(), Clues(), Combat(), drawer, ManualDrawer(), End(), ATTR_KEYS (+9 more)
...
Cohesion: 0.11
Nodes (20): CHOICES, EMOJI, Jokempo(), carregarTentativas(), consumirTentativa(), marcarCartaGanha(), registrarPartida(), registrarPontuacaoRanking() (+12 more)
...
Cohesion: 0.11
Nodes (20): GanguesDescanso(), ATTR_ORDER, bonusResumo(), GanguesEquipPanel(), ganguesTemMultiplayer(), clamp(), GanguesClube(), PORTA (+12 more)
...
Cohesion: 0.19
Nodes (14): AnalyticsTracker(), elementIdentity(), safeDestination(), SCROLL_MARKS, CookieBanner(), cleanParams(), cleanValue(), setAnalyticsUser() (+6 more)
...
- **Why does `useLanguage()` connect `Community 12` to `Community 0`, `Community 1`, `Community 8`, `Community 9`, `Community 10`, `TypewriterPhrase.jsx`, `Quiz.jsx`, `endBattle`, `Community 19`, `Community 20`, `Lobby.jsx`, `AuthContext.jsx`, `UniversosHub.jsx`, `drawCombatBoard`, `BuildingInterior.jsx`, `Community 29`, `PuzzleStealthGrid.jsx`, `initBattle`, `Community 33`, `PerfilColecao.jsx`, `getElem`, `combat.js`, `RadioNina.jsx`, `PuzzleForça.jsx`, `Universo.jsx`, `react`, `useRafaelI18n`, `combat.js`, `classTree.js`, `PuzzleStealthGrid`, `ResultCard.jsx`, `Community 49`, `Perfil.jsx`, `TypewriterPhrase.jsx`, `Create`, `TopTrumpsCard.jsx`, `SearchModal.jsx`, `Criatura.jsx`, `useGanguesI18n.js`, `combat.js`, `useSharedLobbyMachine.js`, `useEventos`, `PuzzleForça.jsx`, `useScrollReveal`, `Phase0Start.jsx`, `RestaurarSaude.jsx`, `useGameStore.js`, `index.js`, `Phase0Start.jsx`, `SearchModal.jsx`, `useSharedLobbyMachine.js`, `Calendario.jsx`, `sanguinaria.js`, `audioManager.js`, `paridade-exata.mjs`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `useReader()` connect `endBattle` to `Community 0`, `Community 1`, `PerfilColecao.jsx`, `Community 3`, `Community 9`, `Community 12`, `combat.js`, `useSharedLobbyMachine.js`, `Phase0Start.jsx`, `Perfil.jsx`, `Community 20`, `Lobby.jsx`, `TopTrumpsCard.jsx`, `audioManager.js`, `useSharedLobbyMachine.js`, `useEventos`, `Community 29`, `PuzzleStealthGrid.jsx`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `SFX` connect `Community 7` to `initBattle`, `PerfilColecao.jsx`, `Community 12`, `useSharedLobbyMachine.js`, `Perfil.jsx`, `Community 29`?**
