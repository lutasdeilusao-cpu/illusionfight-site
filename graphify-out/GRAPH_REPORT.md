...
## Summary
- 4172 nodes · 7765 edges · 390 communities (258 shown, 132 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 53 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7dc2acac`
...
## Communities (390 total, 132 thin omitted)
...
Cohesion: 0.09
Nodes (38): GuestNotice(), registrarPontuacaoArenaRanking(), GanguesDescanso(), GanguesPapo(), GangDialog(), temCena(), getGanguesPartySizeLimit(), getGanguesRosterLimitComHistoria() (+30 more)
...
Cohesion: 0.09
Nodes (33): UnifiedNotification(), AchievementsContext, useAchievements(), useDix(), EventosContext, METAS_PROGRESSO, useEventos(), useFichas() (+25 more)
...
Cohesion: 0.06
Nodes (39): App(), AchievementsProvider(), AuthContext, AuthProvider(), DixProvider(), EventosProvider(), ADMIN_EMAILS, FICHAS_POR_TIER (+31 more)
...
Cohesion: 0.10
Nodes (26): badgeCorClass(), ProdutoDigitalCard(), ShopSection(), ADMIN_EMAILS, DixContext, ensureUserProfile(), wait(), assertExternalPurchasesAllowed() (+18 more)
...
Cohesion: 0.10
Nodes (20): GanguesParada(), CENA_PISTA, CENAS_POR_ID, contarCena(), portaoAberto(), COLLIDERS, ENTRY_ZONES, estadoPoi() (+12 more)
...
Cohesion: 0.10
Nodes (38): CapCard(), Farol(), pesoIndex(), PESOS, TrialBanner(), contoLiberado(), estaDisponivel(), useAuth() (+30 more)
...
Cohesion: 0.04
Nodes (60): AchievementToast(), BackToGamesBtn(), DesktopShellBar(), PuzzleSimonSays(), SearchModal(), TypewriterPhrase(), useLanguage(), index (+52 more)
...
Cohesion: 0.05
Nodes (81): attack, fast, lucky, ATTRIBUTES, GanguesProgressionPanel(), SPECIAL_ICON, createGanguesTemplateSheet(), GANGUES_CHARACTER_BY_ID (+73 more)
...
## Knowledge Gaps
- **1754 isolated node(s):** `PUBLIC_ROUTES`, `AUTH_ROUTES`, `ADMIN_ROUTES`, `name`, `private` (+1749 more)
...
- **Why does `useLanguage()` connect `levelProgression.js` to `Community 0`, `Community 1`, `Community 4`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `endBattle`, `sfx.js`, `CityOverworld.jsx`, `useRadioNina.js`, `Community 20`, `Lobby.jsx`, `supabase.js`, `UniversosHub.jsx`, `DeckBuilder.jsx`, `levelProgression.js`, `Community 29`, `useTopTrumpsRewards.js`, `PuzzleStealthGrid.jsx`, `initBattle`, `Community 33`, `TopTrumpsMP.jsx`, `Criatura.jsx`, `useRadioNina.js`, `personalidades.js`, `useJackStore.js`, `ganguesSpecialEffects.js`, `react`, `PuzzleForça.jsx`, `classTree.js`, `Community 49`, `RestaurarSaude.jsx`, `Community 51`, `TopTrumpsCard.jsx`, `useSharedLobbyMachine.js`, `useTopTrumpsRewards.js`, `PuzzleForça.jsx`, `useScrollReveal`, `useGameStore.js`, `react-markdown`, `sanguinaria.js`, `drawCombatBoard`?**
  _High betweenness centrality (0.153) - this node is a cross-community bridge._
- **Why does `useReader()` connect `CityOverworld.jsx` to `Community 0`, `Community 1`, `TopTrumpsMP.jsx`, `Community 3`, `Community 4`, `levelProgression.js`, `Community 6`, `useJackStore.js`, `PuzzleForça.jsx`, `endBattle`, `Community 20`, `TopTrumpsCard.jsx`, `DeckBuilder.jsx`, `levelProgression.js`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `TopTrumpsMP.jsx` to `Community 1`, `Community 4`, `Community 9`, `endBattle`, `sfx.js`, `CityOverworld.jsx`, `useRadioNina.js`, `Community 20`, `supabase.js`, `levelProgression.js`, `Community 29`, `Community 33`, `useRadioNina.js`, `levelProgression.js`, `useJackStore.js`, `PuzzleForça.jsx`, `react`, `useTopTrumpsRewards.js`, `drawCombatBoard`?**
