...
## Corpus Check
- 885 files · ~1,041,861 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4248 nodes · 7568 edges · 424 communities (292 shown, 132 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 56 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `97a2c66b`
...
## Communities (424 total, 132 thin omitted)
...
Cohesion: 0.31
Nodes (6): BackToGamesBtn(), DueloMenu(), formatTempo(), GAMES, MiniGames(), STEALTH_CONFIG
...
Cohesion: 0.05
Nodes (30): SFX, GangDialog(), BulletHellRafael(), CFG, hexAlpha(), PuzzleBulletHellRafael(), CFG, GlitchRafael() (+22 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (51): AchievementToast(), CharacterCard(), DeferredSection(), SearchModal(), ShopSection(), TypewriterPhrase(), useLanguage(), index (+43 more)
...
Cohesion: 0.08
Nodes (43): GuestNotice(), LoginGate(), UnifiedNotification(), AchievementsContext, AchievementsProvider(), useAchievements(), AuthContext, AuthProvider() (+35 more)
...
Cohesion: 0.15
Nodes (10): ArenaTaticsRoute(), randomPick(), Derrota(), Intro(), LINES_EN, LINES_ES, LINES_PT, Vitoria() (+2 more)
...
Cohesion: 0.10
Nodes (23): BANCO, CONFIGS, prepararUnidades(), PuzzleAnagrama(), shuffleArray(), getTelefonema(), TELEFONEMA_PADRAO, TELEFONEMA_POR_CASO (+15 more)
...
Cohesion: 0.14
Nodes (21): ReaderContext, ReaderProvider(), useReader(), CodigoPerdido(), DIF_CFG, KEYBOARD_ROWS, pick(), PuzzleCodigoPerdido() (+13 more)
...
Cohesion: 0.07
Nodes (43): CapCard(), Farol(), pesoIndex(), PESOS, LOCALES, Navbar(), contoLiberado(), estaDisponivel() (+35 more)
...
- **Why does `useLanguage()` connect `Community 8` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `local`, `Community 7`, `Community 9`, `Community 10`, `Phase0Start.jsx`, `endBattle`, `useSharedLobbyMachine.js`, `CityOverworld.jsx`, `Create`, `Community 20`, `UniversosHub.jsx`, `Universo.jsx`, `levelProgression.js`, `Community 29`, `Jokempo.jsx`, `PuzzleStealthGrid.jsx`, `initBattle`, `Community 33`, `TopTrumpsMP.jsx`, `PerfilColecao.jsx`, `getElem`, `useJackStore.js`, `GanguesLobby.jsx`, `PowerCard.jsx`, `react`, `Leaderboard.jsx`, `combat.js`, `Community 49`, `Perfil.jsx`, `TopTrumpsCard.jsx`, `combat.js`, `PuzzleForça.jsx`, `getElem`, `useScrollReveal`, `Phase0Start.jsx`, `RestaurarSaude.jsx`, `useGameStore.js`, `Number`, `personalidades.js`, `LDINotification.jsx`, `ganguesCharacters.js`, `useGanguesTurnMachine.js`, `PuzzleStealthGrid.jsx`, `audioManager.js`?**
  _High betweenness centrality (0.122) - this node is a cross-community bridge._
- **Why does `useReader()` connect `PerfilColecao.jsx` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 7`, `Community 9`, `combat.js`, `useSharedLobbyMachine.js`, `CityOverworld.jsx`, `Community 20`, `TopTrumpsCard.jsx`, `Jokempo.jsx`, `audioManager.js`, `Community 29`, `getElem`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `CityOverworld.jsx` to `Community 1`, `Community 8`, `Community 9`, `endBattle`, `useSharedLobbyMachine.js`, `Community 20`, `levelProgression.js`, `Jokempo.jsx`, `Community 29`, `Community 33`, `TopTrumpsMP.jsx`, `PerfilColecao.jsx`, `useJackStore.js`, `GanguesLobby.jsx`, `Leaderboard.jsx`, `combat.js`, `TopTrumpsCard.jsx`, `getElem`, `LDINotification.jsx`?**
