...
## Summary
- 4308 nodes · 7658 edges · 413 communities (278 shown, 135 thin omitted)
...
- `GanguesLoja()` --calls--> `getGanguesEquip()`  [EXTRACTED]
  src/pages/games/Gangues/components/cena/GanguesLoja.jsx → src/pages/games/Gangues/data/ganguesEquip.js
...
## Communities (413 total, 135 thin omitted)
...
Cohesion: 0.12
Nodes (22): CharacterCard(), DeferredSection(), DATA, GROUP_LABELS, GROUP_ORDER, usePersonagem(), usePersonagens(), usePersonagensAgrupados() (+14 more)
...
Cohesion: 0.09
Nodes (27): externalMap, Footer(), routeMap, LOCALES, Navbar(), SOCIAL_LINKS, SocialBar(), SITE_CONFIG (+19 more)
...
### Community 15 - "sfx.js"
Cohesion: 0.16
Nodes (16): ATTR_ORDER, bonusResumo(), GanguesEquipPanel(), CATALOGO, createGanguesEquipInstance(), emptyGanguesEquipment(), GANGUES_EQUIP, GANGUES_EQUIP_ATTR_KEYS (+8 more)
...
Cohesion: 0.05
Nodes (61): GanguesDescanso(), GanguesPapo(), CENA_PISTA, CENAS_POR_ID, temCena(), createGanguesTemplateSheet(), GANGUES_CHARACTER_BY_ID, GANGUES_CHARACTER_CATALOG (+53 more)
...
Cohesion: 0.09
Nodes (32): AchievementsProvider(), AuthContext, AuthProvider(), DixContext, DixProvider(), useDix(), EventosProvider(), ADMIN_EMAILS (+24 more)
...
Cohesion: 0.23
Nodes (12): ATTR_ORDER, bonusResumo(), DetalheItem(), GanguesLoja(), LinhaComparacao(), applyGanguesEquipResources(), getGanguesAttributesWithEquip(), previewGanguesAttributesWithEquip() (+4 more)
...
Cohesion: 0.21
Nodes (11): FichaGateRoute(), getHoje(), isDesbloqueadoHoje(), ModalConfirmacaoFicha(), ModalSemFichas(), ABAS, ADMIN_EMAILS, BADGE_CORES (+3 more)
...
Cohesion: 0.06
Nodes (40): AchievementToast(), BackToGamesBtn(), DesktopShellBar(), GuestNotice(), SearchModal(), TypewriterPhrase(), useLanguage(), index (+32 more)
...
Cohesion: 0.07
Nodes (37): ReaderContext, ReaderProvider(), useReader(), Clues(), Combat(), drawer, ManualDrawer(), End() (+29 more)
...
Cohesion: 0.08
Nodes (41): CapCard(), Farol(), pesoIndex(), PESOS, contoLiberado(), estaDisponivel(), SEASON_ONE_COMPLETION, SEASON_ONE_DROPS (+33 more)
...
Cohesion: 0.09
Nodes (12): platformIconMap, allImages, Musicas(), shuffleArray(), JOGOS, HomeSectionHeading(), allImages, MusicCircle() (+4 more)
...
Cohesion: 0.15
Nodes (17): AnalyticsTracker(), elementIdentity(), safeDestination(), SCROLL_MARKS, CookieBanner(), cleanParams(), cleanValue(), setAnalyticsUser() (+9 more)
